...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        input#ContentPlaceHolder1_btnDelete2 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete3 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete4 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete5 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete6 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete7 {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete1:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete2:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete3:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete4:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete5:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete6:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
        ...
        input#ContentPlaceHolder1_btnDelete7:hover {
            border-radius: 10px;
            padding: 5px;
            background: #e93a3a;
            color: white;
                                ...
                                <tbody>
                                    <div id="installationType1" runat="server" visible="False">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button runat="server" ID="btnDelete1" Text="DELETE" CssClass="submit btn-danger" OnClick="btnDelete1_Click" />
                                            </td>
                                        </tr>
                                    </div>
