<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisor/Supervisor.Master" AutoEventWireup="true" CodeBehind="TestReportSU.aspx.cs" Inherits="CEIHaryana.Supervisor.TestReportSU" %>
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
            <div class="card-body">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                            <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;  margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                        <div class="card-body" id="divLine" asp-validation-summary="ModelOnly" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-4">
                                ...
                                <asp:DropDownList class="form-control  select-form select2" TabIndex="1" runat="server" AutoPostBack="true" ID="ddlLineVoltage" selectionmode="Multiple" Style="width: 100% !important;" >
                                </asp:DropDownList>
                            ...
                            <div class="col-4">
                                ...
                                <asp:DropDownList class="form-control  select-form select2" TabIndex="3" runat="server"  AutoPostBack="true" ID="ddlLineType" selectionmode="Multiple" Style="width: 100% !important">
                                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                    ...
                    <div id="LineTypeOverhead" runat="server" visible="false">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <asp:DropDownList class="form-control  select-form select2" TabIndex="5" runat="server" AutoPostBack="true" ID="ddlConductorType" Style="width: 100% !important">
                                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                ...
                <samp style="color: red">* </samp>
                    ...
                    <div id="Earthing" runat="server" visible="false">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <asp:DropDownList class="form-control  select-form select2" TabIndex="12" runat="server" AutoPostBack="true" ID="ddlNoOfEarthing" selectionmode="Multiple" Style="width: 100% !important" >
                                </asp:DropDownList>
                    ...
                    <div class="row">
                      ...
                      <asp:Button ID="btnSubmit"  Text="Submit" runat="server" class="btn btn-primary mr-2" ValidationGroup="Submit" />
                        </div>
                        <div class="col-4">
