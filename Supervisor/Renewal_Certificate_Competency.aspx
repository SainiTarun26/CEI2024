        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
         ...
         <samp style="color: red">* </samp>
                        ...
                        <div class="col-md-4" runat="server" visible="true">
                            ...
                            <asp:TextBox class="form-control" ReadOnly="true" ID="txtaddress" runat="server" autocomplete="off" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                Style="margin-left: 18px;">
                            </asp:TextBox>
...
Please Select
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtChallan" ValidationGroup="Submit" ForeColor="Red">Please Upload</asp:RequiredFieldValidator>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="display: flex; align-items: center;">
                            <asp:CheckBox ID="chkdeclaration2" runat="server" Text="&nbsp; &nbsp;I am authorized to sign the application as COMPETENCY/on behalf of the COMPETENCY." />
                        </div>
