                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3" id="Div1" runat="server">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtLineLength" onKeyPress="return isdecimalKey(event, this);" onkeydown="return preventEnterSubmit(event)" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                            ...
                            <div id="OverheadBare" visible="false" runat="server">
                                <div class="row" style="margin-top: 20px;">
                                    ...
                                    <div class="col-md-3" id="Div2" runat="server">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtConductorSize" onKeyPress="return isdecimalKey(event, this);" onkeydown="return preventEnterSubmit(event)" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    ...
                                    <div class="col-md-3" id="Div3" runat="server">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtGroundWireSize" onKeyPress="return isdecimalKey(event, this);"  onkeydown="return preventEnterSubmit(event)" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
