<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisor/Supervisor.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SupervisorSubstationTestReport.aspx.cs" Inherits="CEIHaryana.Supervisor.SupervisorSubstationTestReport" %>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    ...
                    <asp:GridView class="table-responsive table table-hover table-striped" ID="GridView1" runat="server" Width="100%" AllowPaging="true" PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderStyle Width="38%" CssClass="headercolor" />
                                <ItemStyle Width="38%" />
                                <HeaderTemplate>
