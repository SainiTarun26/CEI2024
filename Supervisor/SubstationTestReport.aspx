    ...
    <div class="content-wrapper">
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
                                    ...
                                    <div id="InCaseOfOil" runat="server" visible="false">
                                        <div class="row">
                                            <div class="col-3" id="PrimaryVoltageLevel" runat="server" visible="false">
                                                <label for="Voltage">
                                                    Primary voltage(in Volt)  <samp style="color: red">* </samp>
                                                </label>
                                            ...
                                            <div class="col-3">
                                                <label for="Voltage">
                                                    Secondary Voltage(in Volt) <samp style="color: red">* </samp>
                                                </label>
                                            ...
                                            <div id="Capacity" class="col-3" runat="server" visible="false">
                                                <label for="Voltage">
                                                    Capacity of oil(in liters) <samp style="color: red">* </samp>
                                                </label>
            ...
            <samp style="color: red">* </samp>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4" runat="server" id="OtherLaDiv" visible="false">
                                                    <label for="Voltage">
                                                        Other (LA) Location  
 <samp style="color: red">* </samp>
                                                    </label>
                            ...
                            <div class="row" style="margin-top: 50px;" id="Declaration" runat="server" visible="false">
                                <div class="col-md-12" style="text-align: center;">
                                    <asp:CheckBox ID="CheckBox2" runat="server" OnCheckedChanged="CheckBox2_CheckedChanged" AutoPostBack="true" Text="&nbsp;This is to certify that the electrical installation is complete in all respects and the work has been carried out
...
conforming to the CEA (Measures relating to Safety & Electric Supply) Regulation, 2023 and relevant standards. The
Site tests done are found to be in order and it is electrically safe to operate the apparatus free from any danger. </text>
                        </div>--%>
