<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Certificate_of_CompetencyPreview.aspx.cs" Inherits="CEIHaryana.Previewpages.Certificate_of_CompetencyPreview" %>
...
"
  ...
  <asp:Image ID="imgQRCode" runat="server" ImageUrl="../Image/Image/Sample_QR.png" />
</span>
                                    </div>
                                </div>
...
qualifications and experience as certained by the Screening Committee, found eligible for grant of  Certificate of Competency., is hereby granted this Certificate of Competency.</h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9" style="text-align: end">
                                    ...
                                    <asp:Image ID="Image" runat="server" Width="130" Height="50" Style="bottom: 140px; margin-left: -300px;" />
