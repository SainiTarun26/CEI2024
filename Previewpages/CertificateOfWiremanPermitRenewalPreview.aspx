<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateOfWiremanPermitRenewalPreview.aspx.cs" Inherits="CEIHaryana.Previewpages.CertificateOfWiremanPermitRenewalPreview" %>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 15PX;">Initial Issue Date : 
                                        <asp:Label ID="lblInitialIssueDate" runat="server"  Style="font-size: 16px !important;"></asp:Label>
                                    </h6>
...
qualifications and experience as certained by the Screening Committee, found eligible for grant of Wireman Permit, is hereby granted this Wireman Permit.</h6>
                            ...
                            <div class="row">
                                <div class="col-3" style="margin-top: auto;">
                                    ...
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 18px; font-weight: 700;">Date:
