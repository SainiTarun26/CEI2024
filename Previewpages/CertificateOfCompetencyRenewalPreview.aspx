<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateOfCompetencyRenewalPreview.aspx.cs" Inherits="CEIHaryana.Previewpages.CertificateOfCompetencyRenewalPreview" %>
...
"
                            ...
                            <div class="row align-items-center" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6 text-center">
                                    <h6 class="card-title fw-semibold mb-1" style="font-size: 19PX;">FORM V</h6>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 15PX;">OLD No. : 
                                        <asp:Label ID="lblOldLicenceNo" runat="server" Text="XXXXX" Style="font-size: 16px !important;"></asp:Label>
                                    </h6>
