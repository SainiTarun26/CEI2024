    ...
    public class TokenManagerConst
    {
        ...
        private static string FetchRefreshToken(string clientId, string clientSecret, Industry_Api_Post_DataformatModel ApiPostformatresult)
        {
            ...
            try
            {
                ...
                CEI CEI = new CEI();
                //CEI.LogToIndustryApiErrorDatabase("https://investharyana.in/api/getrefresh-token", "POST", client.Headers.ToString(), "application/json", inputJson, "200", client.ResponseHeaders.ToString(), response, ApiPostformatresult);
            }
        ...
        private static string FetchAccessToken(string refreshToken, Industry_Api_Post_DataformatModel ApiPostformatresult)
        {
            ...
            try
            {
                ...
                CEI CEI = new CEI();
                //CEI.LogToIndustryApiErrorDatabase("https://investharyana.in/api/getaccess-token", "POST", client.Headers.ToString(), "application/json", inputJson, "200", client.ResponseHeaders.ToString(), response, ApiPostformatresult);
            }
            catch (WebException ex)
            {
                string response = null;
