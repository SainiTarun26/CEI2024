<%@ Page Title="" Language="C#" MasterPageFile="~/Superintendent/Superintendent.Master" AutoEventWireup="true" CodeBehind="Approved_Final_Recommendations_List.aspx.cs" Inherits="CEIHaryana.Superintendent.Approved_Final_Recommendations_List" %>
                ...
                <div class="row ">
                    <div class="col-sm-10 col-md-4">
                        <h6 class="card-title fw-semibold mb-4">
                            <asp:Label ID="lblData" runat="server"></asp:Label>Approved Final Recommendations</h6>
                    </div>
