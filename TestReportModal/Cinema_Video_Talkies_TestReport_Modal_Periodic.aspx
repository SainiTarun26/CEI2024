<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cinema_Video_Talkies_TestReport_Modal_Periodic.aspx.cs" Inherits="CEIHaryana.TestReportModal.Cinema_Video_Talkies_TestReport_Modal_Periodic" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindow() {
            var newWindow = window.open('../SiteOwnerPages/Print_Cinema_Talkies_Test_Report_Modal_Periodic.aspx', '_blank');
            newWindow.focus();
                ...
                <li class="tab-content tab-content-3 typography">
                    ...
                    <div class="row" style="margin-bottom: 15PX;">
                        <div class="col-sm-12" style="text-align: center; padding-top: 8px; padding-bottom: 8px; border-radius: 10px;">
                            <h6 class="card-title fw-semibold mb-4" style="font-weight: 700; margin-bottom: 0px !important; font-size: 32PX;">Site Details & Test Details (Cinema/Video Talkies)</h6>
                                ...
                                <div>
                                    <div class="row row-modal">
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox ReadOnly="true" class="form-control" ID="txtApplicantType" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>
                                        <div class="col-md-3">
                                            <label>
                                                Electrical Installation For<samp style="color: red"> * </samp>
                                            </label>
                                            <asp:TextBox ReadOnly="true" class="form-control" ID="txtInstallationFor" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="Address">
                                                Address of Site(Preferred As Per Demand Notice of Utility or Electricity Bill)</label>
                                            <asp:TextBox ReadOnly="true" class="form-control" ID="txtAddress" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>

                                        <div class="col-md-3" runat="server">
                                            <label>State</label>
                                            <asp:TextBox ReadOnly="true" class="form-control" ID="txtState" Text="Haryana" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <label> Contact Number (Site Owner) </label>
                            ...
                            <div class="card" style="background: #fcfcfc; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; margin-left: -25px; margin-right: -25px; margin-top: 20px; padding: 15px; padding-bottom: 45px;">
                                ...
                                <div class="row">
                                    <div class="col-4" id="Div2" runat="server">
                                        ...
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtWorkIntimationId" autocomplete="off"  runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-4" id="Div5" runat="server">
                                        ...
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtScreenName" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    <div class="col-4" id="Div4" runat="server">
                                        <label>
                                            No. of Installations
                                        </label>
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtInstallationNo" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-4" id="Div7" runat="server">
                                        ...
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtScreenSize" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    <div class="col-4" id="Div1" runat="server">
                                        <label>
                                            Last Inspection Date
                                        </label>
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtLastInspectiondate" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    <div class="col-4" id="Div9" runat="server">
                                        <label>
                                            Test Report Created By
                                        </label>
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtTRCreatedBy" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                    <div class="col-4" id="Div10" runat="server">
                                        <label>
                                            Test Report Created Date
                                        </label>
                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtTRCreatedDate" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
