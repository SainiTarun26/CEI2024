...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindow() {
            var newWindow = window.open('../SiteOwnerPages/PrintEscalatorPeriodicTestReport.aspx', '_blank');
            newWindow.focus();
                        ...
                        <div class="card" style="background: #fcfcfc; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; margin-left: -25px; margin-right: -25px; margin-top: 20px; padding: 15px; padding-bottom: 45px; margin-left: 1px; margin-right: 1px; margin-left: 1px; margin-right: 1px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:TextBox ReadOnly="true" class="form-control" ID="txtMemoNo" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:TextBox ReadOnly="true" class="form-control" ID="txtMemoDate" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
