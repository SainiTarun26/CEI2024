<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiftTestReportModal_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.TestReportModal.LiftTestReportModal_IndustryLift" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindow() {
            var newWindow = window.open('../SiteOwnerPages/PrintLiftTestReport_IndustryLift.aspx', '_blank');
            newWindow.focus();
        ...
        <samp style="color: red">* </samp>
                                    ...
                                    <samp style="color: red">* </samp>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:TextBox ReadOnly="true" class="form-control" AutoPostBack="true" ID="txtLiftType" MaxLength="10" onKeyPress="return isNumberKey(event) && preventZero(event);" onkeydown="return preventEnterSubmit(event)" placeholder="" autocomplete="off" TabIndex="5" runat="server" Style="margin-left: 18px"></asp:TextBox>
