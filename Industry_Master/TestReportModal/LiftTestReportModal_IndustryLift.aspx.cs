...
{
    public partial class LiftTestReportModal_IndustryLift : System.Web.UI.Page
    {
        CEI CEI = new CEI();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    if (Convert.ToString(Session["LiftTestReportID_IndustryLift"]) != null && Convert.ToString(Session["LiftTestReportID_IndustryLift"]) != "")
                    {
                        TestReportId = Session["LiftTestReportID_IndustryLift"].ToString();
        ...
        private void GetDocument(string TestReportId)
        {
            ...
            ds = CEI.GetAttachments_IndustryLift(TestReportId);
            if (ds.Rows.Count > 0)
            {
        ...
        public void GetDetailswithId(string TestReportId)
        {
            try
            {
                ...
                ds = CEI.GetLiftTestReportModalData_IndustryLift("Lift", TestReportId);
