<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EscalatorPeriodicTestReportModal_PeriodicIndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.TestReportModal.EscalatorPeriodicTestReportModal_PeriodicIndustryLift" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindow() {
            var newWindow = window.open('../SiteOwnerPages/PrintEscalatorPeriodicTestReport_PeriodicIndustryLift.aspx', '_blank');
            newWindow.focus();
