<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/PeriodicInspection.Master" AutoEventWireup="true" CodeBehind="Periodic_Renewal.aspx.cs" Inherits="CEIHaryana.Industry_Master.Periodic_Renewal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            ...
            window.location.href = "/Industry_Master/Periodic_Renewal_Cart.aspx";
