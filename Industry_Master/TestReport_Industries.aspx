<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/PeriodicInspection.Master" AutoEventWireup="true" CodeBehind="TestReport_Industries.aspx.cs" Inherits="CEIHaryana.Industry_Master.TestReport_Industries" %>
            ...
            <div class="card-body">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px;">
                    ...
                    <table class="table table-responsive">
                        <asp:GridView class="table-responsive table table-hover table-striped" ID="GridView1" runat="server" Width="100%" AllowPaging="true" PageSize="25" 
                         OnRowCommand="GridView1_RowCommand"   AutoGenerateColumns="false"  BorderWidth="1px" BorderColor="#dbddff">
