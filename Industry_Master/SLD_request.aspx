<%@ Page Language="C#" MasterPageFile="~/Industry_Master/SLD.Master" AutoEventWireup="true" CodeBehind="SLD_request.aspx.cs" Inherits="CEIHaryana.Industry_Master.SLD_request" %>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="text-align: center;">
                        <label id="DataUpdated1" runat="server" visible="false" style="color: red; font-size: 1.125rem">
                            Data Updated Successfully !!!.
                        </label>
                        <label id="DataSaved1" runat="server" visible="false" style="color: red; font-size: 1.125rem">
                        ...
                        <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                            <div>
                                <div class="row" style="margin-bottom: 8px;">
                                  ...
                                  <asp:GridView class="table-responsive table table-hover table-striped" ID="Gridview1" runat="server" Width="100%"  OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand"
                                   ...
                                   <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;" id="Document" runat="server" visible="True">
                                     <div class="row">
                                          <div class="col-md-4">
                                            ...
                                            <asp:DropDownList class="form-control  select-form select2" Style="width: 100% !important;"  ID="ddlSiteOwnerAddress" TabIndex="12" runat="server">
                                            </asp:DropDownList>
                ...
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4" style="text-align: center;">
                        <asp:Button type="submit" ID="BtnSubmit" TabIndex="22" ValidationGroup="Submit" Text="Upload" runat="server" Visible="true" class="btn btn-primary mr-2" OnClick="BtnSubmit_Click1"/>

                         <asp:Button type="Back" ID="btnBack1" TabIndex="24" Text="Back" runat="server" Visible="false" class="btn btn-primary mr-2" />
                    </div>
                    <div class="col-md-4"></div>
                </div>
