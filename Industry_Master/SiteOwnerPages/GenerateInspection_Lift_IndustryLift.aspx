<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewLift_Industry.Master" AutoEventWireup="true" CodeBehind="GenerateInspection_Lift_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.GenerateInspection_Lift_IndustryLift" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
            <div class="card-body">
                <div class="card-title" style="text-align: center; font-size: 23px !important;">Raise Request for Inspection For Lift</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="customFile">
                                Demand Notice (Sanction Load)<samp style="color: red"> * </samp>
                            </label>
                    ...
                    <div id="ChallanDetail" runat="server" visible="false" class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 15px;">
                        ...
                        <div class="row" style="margin-top: -40px !important;">
                            <div class="col-4">
                                ...
                                <asp:TextBox ID="txttransactionId" runat="server" MaxLength="20" class="form-control" Font-Size="12px" onkeypress="return isAlphaNumeric(event);" Style="height: 30px;"></asp:TextBox><br />
...
ForeColor="Red"  ErrorMessage="GRN No. must be exactly 10 alphanumeric characters." ValidationExpression="^[a-zA-Z0-9]{10}$"> </asp:RegularExpressionValidator>
    ...
    <script type="text/javascript">
        ...
        function alertWithRedirectdata() {           
            ...
            window.location.href = "/Industry_Master/SiteOwnerPages/InspectionRequestPrint_IndustryLift.aspx";           
        }
    </script>
