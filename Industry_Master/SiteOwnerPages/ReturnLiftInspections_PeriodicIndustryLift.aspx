<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/PeriodicLiftInstallation.Master" AutoEventWireup="true" CodeBehind="ReturnLiftInspections_PeriodicIndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.ReturnLiftInspections_PeriodicIndustryLift" %>
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            if (confirm('Inspection Submitted Successfully')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/ReturnInspections_PeriodicIndustryLift.aspx";
            } else {
            }
        }
    </script>
