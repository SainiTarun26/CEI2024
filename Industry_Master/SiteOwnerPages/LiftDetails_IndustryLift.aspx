<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewLift_Industry.Master" AutoEventWireup="true" CodeBehind="LiftDetails_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.LiftDetails_IndustryLift" %>
    ...
    <script type="text/javascript">
        function alertWithRedirect() {
            if (confirm('Test report has been submitted and is under review by the Contractor for final submission')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/IntimationData_IndustryLift.aspx";
            } else {
            }
        }
    </script>
