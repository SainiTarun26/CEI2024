<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewLift_Industry.Master" AutoEventWireup="true" CodeBehind="LiftInstallationDetails_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.LiftInstallationDetails_IndustryLift" %>
                          ...
                          <Columns>
                              ...
                              <asp:TemplateField HeaderText="Id" Visible="False">
                                  ...
                                  <ItemTemplate>
                                      ...
                                      <asp:Label ID="lblTyps" runat="server" Text='<%#Eval("Typeofinstallation") %>'></asp:Label>
                                      <asp:Label ID="lblhistory" runat="server" Text='<%#Eval("TestReportGenerated") %>'></asp:Label>
                                      ...
                                      <asp:Label ID="lblIHID" runat="server" Text='<%#Eval("Id") %>'></asp:Label>
                              ...
                              <asp:TemplateField HeaderText="Application">
                                  ...
                                  <ItemStyle Width="25%" />
                                  <ItemTemplate>
                                      <asp:Label ID="lblApllication" runat="server" Visible="false" Text='<%#Eval("IntimationId") %>'></asp:Label>
                                      <asp:LinkButton ID="LinkButton4" runat="server" AutoPostBack="true" CommandArgument=' <%#Eval("IntimationId") %> '
                                          CommandName="Select"><%#Eval("IntimationId") %></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:BoundField DataField="Typeofinstallation" HeaderText="Installations Type">
                              ...
                              <asp:BoundField DataField="TestReportGenerated" HeaderText="Test Report Status">
                                  <HeaderStyle HorizontalAlign="Left" Width="15%" CssClass="headercolor" />
                                  <ItemStyle HorizontalAlign="Left" Width="15%" />
                              </asp:BoundField>
