<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/PeriodicLiftInstallation.Master" AutoEventWireup="true" CodeBehind="LiftPeriodicRenewal_PeriodicIndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.LiftPeriodicRenewal_PeriodicIndustryLift" %>
...
<%--                                <asp:DropDownList class="form-control  select-form select2" Visible ="false" runat="server" AutoPostBack="true" ID="ddlDistrict" Style="width: 100% !important">
                                </asp:DropDownList>--%>
                                <asp:TextBox class="form-control" ID="txtDistrict" autocomplete="off" runat="server" Style="margin-left: 18px" MaxLength="5" ReadOnly="true"></asp:TextBox>

                                <asp:RequiredFieldValidator ID="RequiredFieldValidator25" ErrorMessage="Required" ControlToValidate="txtDistrict" runat="server" Display="Dynamic" ValidationGroup="Submit" ForeColor="Red" />
                            </div>
                            <div class="col-md-4" id="divGurugramSelection" runat="server">
                                <label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlGurugram" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Please Select District</asp:RequiredFieldValidator>
                            </div>
    ...
    <script type="text/javascript">
        function alertWithReturnRedirectdata() {
            if (confirm('Application Submitted successfully.')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/ReturnLiftInspections_PeriodicIndustryLift.aspx";
            } else {
            }
        }
    </script>
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            if (confirm('Application Submitted successfully.')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/LiftPeriodic_PeriodicIndustryLift.aspx";
            } else {
            }
        }
    </script>
