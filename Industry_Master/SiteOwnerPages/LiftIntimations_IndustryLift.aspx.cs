...
{
    public partial class LiftIntimations_IndustryLift : System.Web.UI.Page
    {
        CEI cei = new CEI();
        ...
        private void getWorkIntimationData()
        {
            ...
            //ds = cei.IntimationDataforSiteOwner_IndustryLift(Id);
            ds = cei.IntimationDataforSiteOwner_IndustryLift(Id);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                Session["id_IndustryLift"] = lblID.Text;
                //ClientScript.RegisterStaxrtupScript(this.GetType(), "Pop", "showModal();", true);
                //    GetDetails();

                Response.Redirect("/Industry_Master/SiteOwnerPages/LiftInstallationDetails_IndustryLift.aspx");
