<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintLiftPeriodicTestReport_PeriodicIndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.PrintLiftPeriodicTestReport_PeriodicIndustryLift" %>
                        ...
                        <div id="printableDiv">
                            <div class="page1">
                                ...
                                <div id="IntimationData" runat="server" visible="true">
                                    ...
                                    <h6 class="card-title fw-semibold mb-4" style="font-weight: 700; margin-bottom: 0px !important; margin-top: 50px; margin-bottom: -20px !important; margin-left: 0px;">Lift Details</h6>
