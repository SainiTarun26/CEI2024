...
{
    public partial class LiftPeriodic_PeriodicIndustryLift : System.Web.UI.Page
    {
        ...
        protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (Convert.ToString(HdnUserID.Value) != null && Convert.ToString(HdnUserID.Value) != "")
            {
                ...
                Session["Duplicacy_PeriodicIndustryLift"] = "0";
        ...
        {
            DataTable ds = CEI.GetDataForLiftRenewal_PeriodicIndustryLift(District, SiteOwnerId);
                ...
                if (Convert.ToString(HdnUserID.Value) != null && Convert.ToString(HdnUserID.Value) != "")
                {
                    ...
                    foreach (GridViewRow rows in GridView1.Rows)
                    {
                        ...
                        else
                        {
                            ...
                            CEI.TohandleUncheckedCheckbox_PeriodicIndustryLift(LblRegistrationNo.Text, SiteOwnerId);
                        }
                    }
                    ...
                    if (row != null)
                    {
                        ...
                        if (Session["Duplicacy_PeriodicIndustryLift"].ToString().Trim() == "0")
                        {
                            CEI.CheckDuplicacyInLift_PeriodicIndustryLift(LblRegistrationNo.Text, CreatedBy);
                            Session["Duplicacy_PeriodicIndustryLift"] = "1";
                        }
                        else
                        { }
                        DataTable dt = new DataTable();
                        dt = CEI.GetApplicantCode_PeriodicIndustryLift(LblCategory.Text);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        if (chk.Checked)
                        {
                            CEI.Update_LiftRenewalPeriodicInspection_PeriodicIndustryLift(LblRegistrationNo.Text, int.Parse(InstallationId), CreatedBy);
                        }
                        else
                        { }
        ...
        protected void GridViewPayment_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                Session["Amount_PeriodicIndustryLift"] = lblFooterAmount.Text;
        ...
        private void BindGridDocumentsBind()
        {
            ...
            ds = CEI.GetDocumentforLiftPeriodicRenewal_PeriodicIndustryLift();
            if (ds.Rows.Count > 0)
            {
        ...
        {
            DataTable ds = new DataTable();
            ds = CEI.Get_DocumentGridwithOutChallan_PeriodicIndustryLift();
            if (ds.Rows.Count > 0)
            {
                Grd_Document.DataSource = ds;
                Grd_Document.DataBind();
        ...
        protected void PaymentGridViewBind(string selectedType, int LiftCount, int EscaltorCount, int LiftCountForPayment, int EscalatorCountForPayment)
        {
            try
            {
                ...
                dsa = CEI.Payment_LiftPeriodic_PeriodicIndustryLift(selectedType, LiftCount, EscaltorCount, LiftCountForPayment, EscalatorCountForPayment);
            ...
            if (Convert.ToString(Session["SiteOwnerId_PeriodicIndustryLift"]) != null && Convert.ToString(Session["SiteOwnerId_PeriodicIndustryLift"]) != "")
            {
                ...
                try
                {
                    ...
                    if (atLeastOneInspectionChecked)
                    {
                        ...
                        ds = CEI.GetDivisionByDistrict_PeriodicIndustryLift(District);
                        ...
                        TotalAmount = Convert.ToDecimal(Session["Amount_PeriodicIndustryLift"]);
                        ...
                        dsa = CEI.GetApplicantTypeForLift_PeriodicIndustryLift(Session["SiteOwnerId_PeriodicIndustryLift"].ToString());
                        ...
                        dsp = CEI.ToGetStaffIdforPeriodic_PeriodicIndustryLift(Division, "XEN", District);
               ...
               int ServiceType)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    Session["Duplicacy_PeriodicIndustryLift"] = "2";
                    string InspectionId = CEI.InsertInspectionDataForPeriodic_LiftInspection_PeriodicIndustryLift(para_ApplicantType, para_lblCategory, para_District,
                    ...
                    Session["PrintInspectionID_PeriodicIndustryLift"] = InspectionId;
                    UploadCheckListDocInCollection(para_lblCategory, para_CreatedByy, para_lblCategory, InspectionId);

                    foreach (var file in uploadedFiles)
                    {
                        string query = "sp_InsertInspectionAttachments_PeriodicIndustryLift";
