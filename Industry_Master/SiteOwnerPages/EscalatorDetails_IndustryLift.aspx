<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewLift_Industry.Master" AutoEventWireup="true" CodeBehind="EscalatorDetails_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.EscalatorDetails_IndustryLift" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            if (confirm('Escalator Details added Successfully')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/LiftSiteDetails_IndustryLift.aspx";
            } else {
            }
        }
    </script>
    <script type="text/javascript">
        function alertWithReturnRedirectdata() {
            if (confirm('Escalator Details added Successfully')) {
                window.location.href = "/Industry_Master/SiteOwnerPages/ReturnLiftInspections_IndustryLift.aspx";
            } else {
            }
        }
    </script>
