<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewLift_Industry.Master" AutoEventWireup="true" CodeBehind="LiftSiteDetails_IndustryLift.aspx.cs" Inherits="CEIHaryana.Industry_Master.SiteOwnerPages.LiftSiteDetails_IndustryLift" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            ...
            window.location.href = "/Industry_Master/SiteOwnerPages/LiftIntimations_IndustryLift.aspx";
            ...
            <samp style="color: red">* </samp>
                                    ...
                                    <div class="row" id="row2">
                                        <div class="col-md-4" id="individual" runat="server">
                                            ...
                                            <div class="input-box" style="padding-left: 0px !important;">
                                                <asp:TextBox class="form-control" ID="txtName" TabIndex="4" MaxLength="50" onkeydown="return preventEnterSubmit(event)" onKeyPress="return alphabetKey(event)" placeholder="As Per Demand Notice of Utility or Electricity Bill" autocomplete="off" runat="server" Style="margin-left: 18px; box-shadow: none !important;" ReadOnly="True"></asp:TextBox>
                                            </div>
                                    ...
                                    <div class="row" id="row3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDistrict" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Please Enter District</asp:RequiredFieldValidator>
                                        </div>
