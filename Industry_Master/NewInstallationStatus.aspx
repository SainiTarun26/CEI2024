<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/NewInstallation.Master" AutoEventWireup="true" CodeBehind="NewInstallationStatus.aspx.cs" Inherits="CEIHaryana.Industry_Master.NewInstallationStatus" %>
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
            <div class="card-body">
                <div class="row ">
                    <div class="col-sm-4 col-md-4">
                        <h6 class="card-title fw-semibold mb-4">
                            <asp:Label ID="lblData" runat="server"></asp:Label>List of New Installations</h6>
                    </div>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px;">
                    ...
                    <asp:GridView class="table-responsive table table-hover table-striped" ID="GridView1" runat="server" Width="100%" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound"
                        ...
                        <Columns>
                           ...
                           <%--   <asp:BoundField DataField="Id" HeaderText=" Inspec ID ">
