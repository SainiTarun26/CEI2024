<%@ Page Title="" Language="C#" MasterPageFile="~/Industry_Master/PeriodicInspection.Master" AutoEventWireup="true" CodeBehind="GeneratingsetPeriodic_Industry.aspx.cs" Inherits="CEIHaryana.Industry_Master.GeneratingsetPeriodic_Industry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function alertWithRedirectdataRatingofinstallationPage() {
            ...
            window.location.href = "/Industry_Master/TestReport_Industries.aspx";
    ...
    <script type="text/javascript">
        function alertWithRedirectNextProcessExistingPage() {
            ...
            alert('Rating Of Installation of Generating Set Created Successfully');
            window.location.href = "/Industry_Master/PeriodicRenewal_Industry.aspx";
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px 25px 25px 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" id="Div171" runat="server" style="margin-top: -15px;">
                            ...
                            <asp:TextBox class="form-control" MaxLength="6" ReadOnly="false" ID="txtCapacity" onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                        ...
                        <div class="col-md-3" style="margin-top: 15px;">
                            ...
                            <asp:TextBox class="form-control" MaxLength="6" ReadOnly="false" ID="txtGeneratorVoltage" onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
