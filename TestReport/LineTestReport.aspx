<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineTestReport.aspx.cs" Inherits="CEIHaryana.TestReport.LineTestReport" %>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <asp:DropDownList class="form-control  select-form select2" TabIndex="6" runat="server" AutoPostBack="true" ID="ddlLineVoltage" selectionmode="Multiple" Style="width: 100% !important;">
                                                            </asp:DropDownList>
                                                        </div>
                            ...
                            <samp style="color: red">* </samp>
                                    ...
                                    <li class="tab-content tab-content-2 typography">
                                        ...
                                        <samp style="color: red">* </samp>
                                                        ...
                                                        <asp:DropDownList class="form-control  select-form select2" TabIndex="6" runat="server" AutoPostBack="true" ID="ddltransformerType" selectionmode="Multiple" Style="width: 100% !important">
                                                         <asp:ListItem value="" Text="Select"></asp:ListItem>
 ...
 <samp style="color: red">* </samp>
                                ...
                                <samp style="color: red">* </samp>
                                                ...
                                                <samp style="color: red">* </samp>
                                                    ...
                                                    <asp:DropDownList class="form-control  select-form select2" TabIndex="6" runat="server" AutoPostBack="true" ID="ddlGeneratingSetType" selectionmode="Multiple" Style="width: 100% !important">
                                                   <asp:ListItem Text="Select" Value="0"></asp:ListItem>    
                    ...
                    <samp style="color: red">* </samp>
                                                        ...
                                                        <asp:DropDownList class="form-control  select-form select2" TabIndex="6" runat="server" AutoPostBack="true" ID="ddlGeneratingEarthing" selectionmode="Multiple" Style="width: 100% !important">
                                                        </asp:DropDownList>
                                        ...
                                        <div class="card-body" style="margin-top: -45px;">
                                            <div class="row">
                                                ...
                                                <samp style="color: red">* </samp>
                                                    ...
                                                    <asp:DropDownList class="form-control  select-form select2" TabIndex="6" runat="server" AutoPostBack="true" ID="ddlPhaseEarthing" selectionmode="Multiple" Style="width: 100% !important">
                                                    </asp:DropDownList>
                                                </div>
             ...
             <samp style="color: red">* </samp>
                ...
                <samp style="color: red">* </samp>
                                                ...
                                                <div class="row" style="margin-top: 50px;">
                                                      <%--  <div class="col-2"></div>--%>
                                                    <div class="col-12" style="text-align: center;">
                                                        <asp:CheckBox ID="CheckBox4" runat="server"  AutoPostBack="true" Text="&nbsp;I hereby declare that all information submitted as part of the form is true to my knowledge." Font-Size="Medium" Font-Bold="True" />
                                                   <br /> 
