    ...
    <ul>
     ...
     <samp style="color: red">* </samp>
                            ...
                            <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtCableSize1" MaxLength="3" onKeyPress="return isNumberKey(event);" onkeydown="return preventEnterSubmit(event)" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                            ...
                            <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtRailwayCrossingNmbr" MaxLength="2" onKeyPress="return isNumberKey(event);" onkeydown="return preventEnterSubmit(event)"  placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                                ...
                                                <div id="Insulation440vAbove" runat="server" visible="false">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtRedEarthWire" MaxLength="4" onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                            ...
                            <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtYellowEarthWire" MaxLength="4"  onkeydown="return preventEnterSubmit(event)"  onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    ...
                    <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtBlueEarthWire" MaxLength="4"   onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    ...
                    <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtRedYellowPhase" MaxLength="4"  onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    ...
                    <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtBlueYellowPhase" MaxLength="4"  onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    ...
                    <samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtRedBluePhase" MaxLength="4"  onkeydown="return preventEnterSubmit(event)" onkeypress="return isNumberKey(event);" placeholder="" autocomplete="off" TabIndex="2" runat="server" Style="margin-left: 18px"></asp:TextBox>
                            ...
                            <samp style="color: red">* </samp>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4" style="text-align: center;">
                                                        <asp:Button ID="btnSubmit" Text="Next" runat="server" class="btn btn-primary mr-2" ValidationGroup="Submit"
