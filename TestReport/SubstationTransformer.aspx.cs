    ...
    public partial class SubstationTransformer : System.Web.UI.Page
    {
        ...
        public void GetHistoryDataById()
        {
            try
            {
                ...
                {
                    string TestReportId = ds.Tables[0].Rows[0]["TestReportId"].ToString();
                    ...
                    if (TypeOfTransformer != null)
                    {
                        ...
                        if (TypeOfHT == "Breaker")
                        {
                            ...
                            txtBreakerCapacity.Text = ds.Tables[0].Rows[0][""].ToString();

                            string TypeOfLtProtection = ds.Tables[0].Rows[0][""].ToString();
                            ...
                            if (TypeOfLtProtection == "Fuse Unit")
                            {
                                ...
                                txtIndividualCapacity.Text = ds.Tables[0].Rows[0][""].ToString();
                            }
                            else
                            {
                                Breaker.Visible = true;
                                txtLTBreakerCapacity.Text = ds.Tables[0].Rows[0][""].ToString();
                                txtLoadBreakingCapacity.Text = ds.Tables[0].Rows[0][""].ToString();
                                txtSealLevelPlinth.Text = ds.Tables[0].Rows[0][""].ToString();
                            }
                        }
