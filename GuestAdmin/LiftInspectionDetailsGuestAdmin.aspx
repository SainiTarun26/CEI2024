<%@ Page Title="" Language="C#" MasterPageFile="~/GuestAdmin/GuestAdmin.Master" AutoEventWireup="true" CodeBehind="LiftInspectionDetailsGuestAdmin.aspx.cs" Inherits="CEIHaryana.GuestAdmin.LiftInspectionDetailsGuestAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
            ...
            <div class="card" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;" id="DivTestReports" runat="server" visible="false">
