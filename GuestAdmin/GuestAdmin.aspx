<%@ Page Title="" Language="C#" MasterPageFile="~/GuestAdmin/GuestAdmin.Master" AutoEventWireup="true" CodeBehind="GuestAdmin.aspx.cs" Inherits="CEIHaryana.GuestAdmin.GuestAdmin1" %>
                            ...
                            <div class="row m-t-25">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="overview-item overview-item--c1">
                                        <div class="overview__inner">
                                             <a href="TotalRequestInspectionForGuestAdmin.aspx">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="overview-item overview-item--c2">
                                        <div class="overview__inner">
                                             <a href="AcceptedOrRejectedRequestForGuestAdmin.aspx">
                                            <div class="overview-box clearfix">
                                                <div class="icon">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="overview-item overview-item--c3">
                                        <div class="overview__inner">
                                            <a href="InProcessRequestForGuestAdmin.aspx">
                                            <div class="overview-box clearfix">
                                                <div class="icon">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="overview-item overview-item--c4">
                                        <div class="overview__inner">
                                             <a href="NewRequestInspectionForGuestAdmin.aspx">
                                            <div class="overview-box clearfix">
                                                <div class="icon">
                                        ...
                                        <div>
                                            ...
                                            <div id="printableDiv2">
                                               <%-- OnRowCommand="GridView2_RowCommand"--%>
                                                <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView2" Visible="false"
                                                     AllowPaging="true" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDataBound="GridView2_RowDataBound" PageSize="10"
                                            ...
                                            <div class="row" style="text-align: center; margin-top: 10px; margin-bottom: 10px;">
                                                <div class="col-6" id="Back" runat="server" visible="false" style="text-align: end;">
                                                    <a href="/GuestAdmin/GuestAdmin.aspx">
