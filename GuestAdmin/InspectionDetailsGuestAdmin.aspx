<%@ Page Title="" Language="C#" MasterPageFile="~/GuestAdmin/GuestAdmin.Master" AutoEventWireup="true" CodeBehind="InspectionDetailsGuestAdmin.aspx.cs" Inherits="CEIHaryana.GuestAdmin.InspectionDetailsGuestAdmin" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; background: white; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
            ...
            <div class="card" id="TransactionCard" runat="server" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                <div class="row">
                     <div class="col-4" runat="server" id="transactionId" visible="true">
                    ...
                    <div class="col-4" runat="server" id="transactionDate" visible="true">
