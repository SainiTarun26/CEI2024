...
{
    public partial class LiftInspectionDetailsGuestAdmin : System.Web.UI.Page
    {
        CEI CEI = new CEI();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (Convert.ToString(Session["GuestAdmin"]) != null && Convert.ToString(Session["GuestAdmin"]) != "")
                    {
