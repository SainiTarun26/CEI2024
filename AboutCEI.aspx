<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutCEI.aspx.cs" Inherits="CEIHaryana.AboutCEI" %>
...
<body style="zoom: 90% !important;">
 ...
 <br />
      ...
      <a href="UserManual/office order 223.pdf" target="_blank">Mendate Regarding high medium low risk profile</a>
        ...
        <main id="main">
            <!-- ======= About Section ======= -->
            <section id="about" class="about section-bg" style="margin-top: 0px;">
                <div class="row">
