<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OurOnlineServices.aspx.cs" Inherits="CEIHaryana.OurOnlineServices" %>
 ...
 <br />
  ...
  Page before filling the form)                           
    ...
    margin-right: 0px; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <div class="col-md-12">
                            <h7 class="card-title fw-semibold mb-4" style="font-size: 18px !important;">Our Online Services</h7>
                    ...
                    <div class="row" style="margin-left: 10px;">
                        <ul>
                            ...
                            <li>INSPECTION OF ELECTRICAL INSTALLATIONS:
                                <ul>
                                    <li>New/Periodical: Transformer/Sub Station/DG Set/Line/Lift & Escalator/Cinema</li>
                                </ul>
                            </li>
                            <li>INVESTIGATION OF ELECTRICAL ACCIDENTS:
    <ul>
        <li>Fatal Accident/Non-Fatal Accident: Human / Animal</li>
    </ul>
</li>
                            <li>ELECTRICAL CONTRACTOR LICENSE:
    <ul>
        <li>New</li>
        <li>Renewal/Revalidation/ Upgradation</li>
        <li>Duplicate/Continuation/ Transfer/Permanent Cancellation</li>
        <li>Attachment-Detachment of Staff/ Issue of Test Report.</li>
        <li>Renewal/Revalidation/ Upgradation</li>
    </ul>
</li>
 <li>SUPERVISOR COMPETENCY CERTIFICATE:
    <ul>
        <li>New/Upgradation/Screening</li>
        <li>Revalidation/Duplicate/Continuation/Permanent Cancellation</li>
        <li>Renewal</li>
        <li>Examination for New Supervisor</li>
        <li>Grant of Supervisor Competency Certificate in lieu of Certificate from other states</li>
    </ul>
</li>
<li>WIREMAN PERMIT:
    <ul>
        ...
        <li>Revalidation/Duplicate/Continuation/Permanent Cancellation</li>
        <li>Screening</li>
        <li>Examination for New Wireman</li>
        <li>Grant of Supervisor Competency Certificate in lieu of Certificate from other states</li>
    </ul>
</li>
