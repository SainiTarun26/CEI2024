...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <div class="card" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 20px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;border-radius:0px !important;background:#f9f9f9;margin-left: 24px;margin-top:-1px;margin-right:2%;">
