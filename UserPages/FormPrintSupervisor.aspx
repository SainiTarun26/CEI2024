<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="FormPrintSupervisor.aspx.cs" Inherits="CEIHaryana.UserPages.FormPrintSupervisor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div id="printableDiv">
                    <div class="row" style="margin-bottom: 15PX;">
                        ...
                        <div class="col-sm-4" style="text-align: center; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding-top: 8px; padding-bottom: 8px; border-radius: 10px;">
                            <h6 class="card-title fw-semibold mb-4" style="font-weight: 700; margin-bottom: 0px !important; font-size: 32PX;">SUPERVISOR DETAILS</h6>
                        </div>
    ...
    <div class="col-12" style="margin-top:40PX;">
        ...
        <asp:TextBox class="form-control" ID="TextBox3" runat="server" autocomplete="off" onKeyPress="return isNumberKey(
    );"
            TabIndex="5"
            onkeyup="return isvalidphoneno();" MaxLength="10" Style="margin-left: 18px">
        </asp:TextBox>
                        ...
                        <div class="row" style="margin-top: 30px;">
                            ...
                            <div class="col-6">
                                ...
                                <asp:TextBox class="form-control" runat="server" ID="TextBox12" autocomplete="off"
                                    MaxLength="30" Style="margin-left: 18px; text-transform: uppercase">
                                </asp:TextBox>
                    ...
                    <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                        ...
                        <div class="row" style="margin-top: 20px;">
                            ...
                            <div class="col-6">
    <label for="DateofExpiry">
        Current Attached Contractor Detail's(if any)
    </label>
