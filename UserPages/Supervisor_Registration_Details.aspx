<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supervisor_Registration_Details.aspx.cs" Inherits="CEIHaryana.UserPages.Supervisor_Registration_Details" %>
                            ...
                            <div class="card"
                                ...
                                <div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="card-title" style="font-size: 18px !important;">QUALIFICATION DETAILS</h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtUniversity" runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                              <%--  <asp:DropDownList ID="YearDropdown" runat="server" AutoPostBack="True">
                                                                </asp:DropDownList>--%>
                                                                 <asp:TextBox class="form-control" ID="txtYearDropdown" runat="server" Readonly="true" > </asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control" ID="txtmarksObtained" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control" ID="txtmarksmax" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtprcntg" runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr id="diploma" runat="server">
                                                            <td style="text-align: center;">
                                                              <%--  <asp:DropDownList class="select-form select2" ID="ddlQualification1"
                                                                    runat="server" TabIndex="16" AutoPostBack="true">
                                                                ...
                                                                <asp:TextBox class="form-control" ID="txtQualification1" runat="server" Readonly="true"> </asp:TextBox>
                                                                  
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtUniversity2" runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                            <%--    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True">
                                                                </asp:DropDownList>--%>
                                                                   <asp:TextBox class="form-control" ID="txtDropDownList2"  runat="server" Readonly="true"> </asp:TextBox>
                                                                                                               </td>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control" ID="txtmarksObtained2" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control" ID="txtmarksmax2" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control"  ID="txtprcntg2" ReadOnly="true" runat="server"> </asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr id="DdlDegree" runat="server">
                                                            <td style="text-align: center;">
                                                                <%--<asp:DropDownList class="select-form select2" ID="ddlQualification2" runat="server" TabIndex="16" AutoPostBack="true">
                                                                  ...
                                                                  <asp:TextBox class="form-control" ID="txtQualification2"  runat="server" Readonly="true"> </asp:TextBox>
                                                                                                                       </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtUniversity3" runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                            <%--    <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True">
                                                                </asp:DropDownList>--%>
                                                                  <asp:TextBox class="form-control" ID="txtDropDownList3"  runat="server" Readonly="true"> </asp:TextBox>
                                                                  
                                                            </td>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control"  ID="txtmarksObtained3" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control"  ID="txtmarksmax3" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtprcntg3" runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr id="DdlMasters" visible="false" runat="server">
                                                            <td style="text-align: center;">
                                                             <%--   <asp:DropDownList class="select-form select2" ID="ddlQualification3" runat="server" TabIndex="16" AutoPostBack="true">
                                                                  ...
                                                                  <asp:TextBox class="form-control" ID="txtQualification3"  runat="server" Readonly="true"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                               <%-- <asp:DropDownList ID="DropDownList4" runat="server" AutoPostBack="True"></asp:DropDownList>--%>
                                                                  <asp:TextBox class="form-control" ID="txtDropDownList4"  ReadOnly="true" runat="server" > </asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control"  ID="txtmarksObtained4" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox class="form-control"  ID="txtmarksmax4" runat="server" Readonly="true"> </asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control"  ID="txtprcntg4" ReadOnly="true" runat="server"> </asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="row" style="margin-top: 15px;" runat="server" id="certificate">
                                            <div class="col-md-8">
                                                <h4 class="card-title" style="font-size: 15px;">Whether you are holder of certificate of competency issued by any state licincing board/chief electrical inspector.</h4>
                                            </div>
                                            <div class="col-md-2">
                                                        ...
                                                        <tr id="Experience" runat="server" visible="false">
                                                            <td>
                                                               <%-- <asp:DropDownList class="select-form select2" ID="ddlExperience" runat="server" TabIndex="36" AutoPostBack="true">
                                                                ...
                                                                <asp:TextBox ID="txtExperience" runat="server" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            <%--    <asp:DropDownList class="select-form select2" ID="ddlTrainingUnder" runat="server" TabIndex="37" AutoPostBack="true">
                                                                  ...
                                                                  <asp:TextBox ID="txtTrainingUnder" runat="server"  ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            <td>
                                        ...
                                        <div class="row" style="margin-top: 15px;">
                                            ...
                                            <div class="col-md-2">
                                               <%-- <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="true" RepeatDirection="Horizontal">
                                                 ...
                                                 <asp:TextBox class="form-control" ReadOnly="true" autocomplete="off" ID="txtRadioButtonList1" runat="server" AutoPostBack="true"> </asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtEmployerName2" ReadOnly="true" runat="server"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ID="txtDescription2" ReadOnly="true" runat="server" > </asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ReadOnly="true" ID="txtFrom2" runat="server"> </asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox class="form-control" ReadOnly="true" ID="txtTo2" runat="server"> </asp:TextBox>
                                                            </td>
                                                        </tr>
