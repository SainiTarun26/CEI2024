<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contractor_Upgradation.aspx.cs" Inherits="CEIHaryana.UserPages.Contractor_Upgradation" %>
     ...
     <samp style="color: red">* </samp>
                             ...
                             <div class="col-md-4">
                                 <div class="forms-sample">
                                     <div class="form-group">
                                         ...
                                         <asp:TextBox class="form-control" ID="txtTotalAmount" autocomplete="off" ReadOnly="true" runat="server"> </asp:TextBox>
             ...
             <div class="row">
                 ...
                 <div class="col-md-2" style="text-align: center;">
                     <asp:Button ID="Btn_Back" Text="Back" OnClick="Btn_Back_Click" runat="server" ValidationGroup="Submit" class="btn btn-primary" />
                 </div>
             </div>
         </div>
