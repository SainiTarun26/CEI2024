<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supervisor_Upgradation.aspx.cs" Inherits="CEIHaryana.UserPages.Supervisor_Upgradation" %>
        ...
        <samp style="color: red">* </samp>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" runat="server" id="InterviewDate" visible="false" style="margin-top: -30px;">
                                <label>
                                    Date of Interview <samp style="color: red">* </samp>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4" style="text-align: center;">
                            <asp:Button ID="btn_Back" Text="Back" OnClick="btn_Back_Click" runat="server" ValidationGroup="Submit" class="btn btn-primary mr-2" />
                        </div>
                    </div>
