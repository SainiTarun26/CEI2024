                                                    ...
                                                    <div class="forms-sample">
                                                        <div class="form-group">
                                                           <label id ="WireSup" runat="server" visible="true">Name of Applicant<samp style="color: red">* </samp>
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtName" MaxLength="50" autocomplete="off" TabIndex="2" onKeyPress="return alphabetKey(event);" runat="server"> </asp:TextBox>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="forms-sample">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtFatherNmae" MaxLength="50" autocomplete="off" TabIndex="3" onKeyPress="return alphabetKey(event);" runat="server"> </asp:TextBox>
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 0px;">
                                                            ...
                                                            <asp:TextBox class="form-control" ID="txtAadhaar" autocomplete="off" MaxLength="14" onkeypress="return isNumberKey(event)" oninput="formatAadhaarInput()" TabIndex="5" runat="server"> </asp:TextBox>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanelDOB" runat="server">
                                                            <ContentTemplate>
                                                                <div class="form-group" style="margin-top: 20px;">
                                                                    ...
                                                                    <asp:TextBox class="form-control" type="date" autocomplete="off" ID="txtDOB" placeholder="dd/mm/yyyy" runat="server" TabIndex="6" MaxLength="10" min='0000-01-01' max='9999-01-01' AutoPostBack="true" OnTextChanged="txtDOB_TextChanged"> </asp:TextBox>
                                                            </ContentTemplate>
                                                            <Triggers>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtCommunicationAddress" autocomplete="off" TextMode="MultiLine" runat="server" TabIndex="7" MaxLength="200"> </asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtPassword" autocomplete="off" runat="server" TabIndex="18" MaxLength="30" Style="width: 100%;"> </asp:TextBox>
                                        ...
                                        <div class="col-sm-6">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <div class="form-group">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="&nbsp;&nbsp;Permanent Address" Font-Size="Medium" Font-Bold="True" AutoPostBack="true" TabIndex="11" OnCheckedChanged="CheckBox1_CheckedChanged" />
                                                        <asp:TextBox class="form-control" autocomplete="off" ID="txtPermanentAddress" TextMode="MultiLine" TabIndex="12" runat="server"  MaxLength="200"> </asp:TextBox>
                                            ...
                                            <div class="form-group" style="margin-top: -10px;">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" CssClass="validation_required" runat="server" ControlToValidate="txtEmail"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox class="form-control" ID="txtConfirmPswrd" autocomplete="off" runat="server" TabIndex="19" MaxLength="30" Style="width: 100%;"> </asp:TextBox>
