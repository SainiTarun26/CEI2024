<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CEIHaryana.UserPages.WebForm1" %>
                                ...
                                <div class="form-container" style="text-align:center;">
                                    ...
                                    <div>
                                        <div action="#" class="login">
                                            <div class="field">
                                                <input type="text" placeholder="Login ID" style="width:97%;margin-bottom:15px;margin-top:3%;" />
                                            </div>
                                            <div class="field">
                                                <input type="password" placeholder="Password"  style="width:97%;margin-bottom:10px;" />
                                            </div>
                                            <div class="pass-link" style="text-align:end;"><a href="#">Forgot password?</a></div>
