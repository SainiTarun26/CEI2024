...
<head runat="server">
    ...
    <style type="text/css">
        th.headercolor.textalignCenter.sNO {
    width: 15% !important;
}
        th {
    width: 1% !important;
...
<body>
                        ...
                        <div id="printableDiv">
                            <div class="page1">
                                ...
                                <div class="card" id="inspection-card" style="margin-top: 5%;">
                                    ...
                                    <div class="card" id="inspection-card-child3">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="RowNumber" HeaderText="Sr No.">
            <HeaderStyle HorizontalAlign="center" Width="10%" CssClass="headercolor textalignCenter" />
            <ItemStyle HorizontalAlign="center" />
        </asp:BoundField>                               
     
        <asp:BoundField DataField="EarthingType" HeaderText="Earthing Type">
            <HeaderStyle HorizontalAlign="Center" Width="45%" CssClass="headercolor textalignCenter sNO" />
    ...
    <SortedDescendingHeaderStyle BackColor="#00547E" />
                                ...
                                <br />
                                <div class="card-title" id="ApprovalTitle" visible="false" runat="server" style="margin-top: 2%; font-weight: 700; margin-bottom: 0px !important;">Test Report Final Submission Details</div>
