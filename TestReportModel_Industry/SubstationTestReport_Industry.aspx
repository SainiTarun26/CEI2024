<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubstationTestReport_Industry.aspx.cs" Inherits="CEIHaryana.TestReportModel_Industry.SubstationTestReport_Industry" %>
            ...
            <ul style="margin: 20px 20px 20px 15px;">
                <li class="tab-content tab-content-2 typography">
                   <%-- <div class="col-12" style="text-align: end; margin-top: auto; margin-bottom: auto;">
                        <asp:Button ID="btnPrint" Text="Print" Visible="false" runat="server" class="btn btn-primary mr-2"
