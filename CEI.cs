...
string AnyWorkIssued, string CopyOfWorkOrder, string CompletionDateasPerOrder, string CreatedBy)
        {
            ...
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation1;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 10).Value = TypeOfInstallation2;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation2;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation3;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation3;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation4;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation4;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation5;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation5;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation6;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation6;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation7;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation7;
            cmd.Parameters.Add("@WorkDetails", SqlDbType.VarChar, 50).Value = TypeOfInstallation8;
            cmd.Parameters.Add("@VoltageLevel", SqlDbType.VarChar, 10).Value = NumberOfInstallation8;
