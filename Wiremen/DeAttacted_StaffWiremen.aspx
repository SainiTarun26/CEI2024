<%@ Page Title="" Language="C#" MasterPageFile="~/Wiremen/Wiremen.Master" AutoEventWireup="true" CodeBehind="DeAttacted_StaffWiremen.aspx.cs" Inherits="CEIHaryana.Wiremen.DeAttacted_StaffWiremen" %>
    ...
    <asp:TextBox class="form-control" ID="txtControctorId" runat="server" autocomplete="off" ReadOnly="true" onKeyPress="return alphabetKey(event);" TabIndex="1"
        MaxLength="200" Style="margin-left: 18px;">
           ...
           <samp style="color: red">* </samp>
                                    ...
                                    <asp:TextBox class="form-control" ID="txtReId" runat="server" autocomplete="off" ReadOnly="true" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                        MaxLength="200" Style="margin-left: 18px;">
                                    </asp:TextBox>
                                </div>
                                 <div class="col-md-4">
...
<samp style="color: red">* </samp>
    ...
    <asp:FileUpload ID="fileAttachment" runat="server" CssClass="form-control" TabIndex="1"
        Style="margin-left: 18px;padding-top: 2px;
    padding-left: 5px;"   accept=".pdf" />
         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
         ControlToValidate="fileAttachment" ErrorMessage="Required" ValidationGroup="Submit" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
</div>
...
<asp:TextBox class="form-control" ID="txtRemarks" runat="server" TextMode="MultiLine"
    ...
    MaxLength="200" Style="margin-left: 18px;" >
                ...
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4" style="text-align: center;">
                        <asp:Button ID="btnToDeattach" Text="Submit" runat="server" ValidationGroup="Submit" class="btn btn-primary mr-2" OnClick="btnToDeattach_Click" />
                    </div>
                </div>
            </div>
        </div>
