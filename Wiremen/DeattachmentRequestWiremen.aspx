<%@ Page Title="" Language="C#" MasterPageFile="~/Wiremen/Wiremen.Master" AutoEventWireup="true" CodeBehind="DeattachmentRequestWiremen.aspx.cs" Inherits="CEIHaryana.Wiremen.DeattachmentRequestWiremen" %>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Id" Visible="False">
                                <ItemTemplate>
                                  ...
                                  <asp:Label ID="lblRequestFor" runat="server" Text='<%#Eval("Attach_DeAttach") %>'></asp:Label>
                            ...
                            <asp:BoundField DataField="Attach_DeAttach" HeaderText="Request For">
                                <HeaderStyle HorizontalAlign="center" Width="15%" CssClass="headercolor" />
