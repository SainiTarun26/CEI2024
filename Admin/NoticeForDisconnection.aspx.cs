...
{
    public partial class NoticeForDisconnection : System.Web.UI.Page
    {
        CEI CEI = new CEI();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (Convert.ToString(Session["AdminId"]) == Convert.ToString(hdnOwnerId.Value))
                {
                    int ClickCount = 0;
                    ...
                    if (ClickCount < 1)
                    {
                        ...
                        try
                        {
                            ...
                            string AdminId = hdnOwnerId.Value;
                            ...
                            txtPhoneNo.Text.Trim(), ddlCatogary.SelectedItem.Text, txtOther.Text.Trim(), txtSanction.Text.Trim(), AssignTo, txtRemarks.Text.Trim(), AdminId, transaction);
