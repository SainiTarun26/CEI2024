<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="AddContractorDetails.aspx.cs" Inherits="CEI_PRoject.Admin.AddContractorDetails" %>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <asp:TextBox class="form-control" ID="txtFirmName" runat="server" onkeydown="return preventEnterSubmit(event)" autocomplete="off" Style="margin-left: 18px" TabIndex="3" MaxLength="60"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <asp:TextBox class="form-control" ID="txtContactNo" runat="server" autocomplete="off" onkeydown="return preventEnterSubmit(event)"
                                onKeyPress="return isNumberKey();" TabIndex="5" onkeyup="return isvalidphoneno();" MaxLength="10" Style="margin-left: 18px">
                            </asp:TextBox>
