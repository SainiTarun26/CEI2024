<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="IntimationHistoryForLift.aspx.cs" Inherits="CEIHaryana.Admin.IntimationHistoryForLift" %>
...
<div class="row card" style="padding-top: 10px;padding-left:0px !important;padding-right:0px !important;">
        ...
        <asp:GridView ID="grd_Documemnts" CssClass="table table-bordered table-striped table-responsive" runat="server" OnRowCommand="grd_Documemnts_RowCommand" OnRowDataBound="grd_Documemnts_RowDataBound" AutoGenerateColumns="false" AllowPaging="True" PageSize="10">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Previous Documents" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4%">
                    <ItemTemplate>
                        <asp:LinkButton ID="LnkDocumemtPath2" runat="server" Text='<%# Bind("PreviousDocumentPath") %>' CommandArgument='<%# Bind("PreviousDocumentPath") %>' CommandName="Select">Click here to view document </asp:LinkButton>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="2%" CssClass="headercolor"></ItemStyle>
                    <HeaderStyle HorizontalAlign="Left" CssClass="headercolor" />
                </asp:TemplateField>
    ...
    <ContentTemplate>
        <div class="card-body" id="CardId" runat="server" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
            ...
            <div id="Action" runat="server"  style="padding-left: 15px;"> 
                <asp:RadioButtonList ID="RdbtnAccptReturn" AutoPostBack="true" OnSelectedIndexChanged="RdbtnAccptReturn_SelectedIndexChanged" runat="server" RepeatDirection="Horizontal" TabIndex="25">
                    <asp:ListItem Text="Yes(Accept)" Value="0" style="padding-left: 5px; margin-right: 5px;"></asp:ListItem>
                    <asp:ListItem Text="No(Return)" Value="1" style="padding-left: 5px; margin-right: 5px;"></asp:ListItem>
                    <asp:ListItem Text="Reject" Value="2"  style="padding-left: 5px;"></asp:ListItem>
                </asp:RadioButtonList>
                        ...
                        <asp:GridView ID="grd_ChecklistDocumemnts" CssClass="table table-bordered table-striped table-responsive" runat="server" OnRowCommand="grd_Documemnts_RowCommand" AutoGenerateColumns="false" >
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-BackColor="#9292cc" HeaderStyle-ForeColor="white">
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chk_Select1" runat="server" AutoPostBack="true" OnCheckedChanged="chk_Select_CheckedChanged1" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="SNo">
                                    <HeaderStyle Width="5%" CssClass="headercolor" />
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="text-align: center;">
               <%-- <asp:Button ID="btnPreview" Text="Preview" runat="server" Visible="false" class="btn btn-primary mr-2" OnClick="btnPreview_Click" />--%>
                 <asp:Button ID="btnUpdate" Text="Submit" runat="server" ValidationGroup="Submit" class="btn btn-primary mr-2"  Style="padding-left: 30px; padding-right: 30px;"  OnClick="btnUpdate_Click"/>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            function alertWithRedirectdataCommonReturn() {
                ...
                window.location.href = "/Admin/IntimationHistoryForAdmin.aspx";
            }
        </script>
    <%--<script>
