<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="PeriodicInspection_Cinema_Talkies_Admin.aspx.cs" Inherits="CEIHaryana.Admin.PeriodicInspection_Cinema_Talkies_Admin" %>
                ...
                <ContentTemplate>
                    <div class="row" style="margin-left: 0px;">
                        ...
                        <asp:RadioButtonList ID="RadioButtonList2" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged" AutoPostBack="true" runat="server" RepeatDirection="Horizontal" TabIndex="25">
                            ...
                            <asp:ListItem Text="No(Return)" Value="1"  disabled ="true" style="margin-top: auto; margin-bottom: auto;"></asp:ListItem>
