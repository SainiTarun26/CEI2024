<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="NoticeForDisconnection.aspx.cs" Inherits="CEIHaryana.Admin.NoticeForDisconnection" %>
...
<div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius: 5px !important">
    ...
    <div class="input-group">
        <asp:TextBox CssClass="form-control" ID="txtName" runat="server" autocomplete="off"  AutoPostBack="true" OnTextChanged="txtName_TextChanged"
            onKeyPress="return alphabetKey(event);" TabIndex="1" MaxLength="200"
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>Notice to Utilities for Disconnection of supply. <samp style="color: red">*</samp>
                </td>
