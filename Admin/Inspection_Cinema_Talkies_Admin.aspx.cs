...
{
    public partial class Inspection_Cinema_Talkies_Admin : System.Web.UI.Page
    {
        CEI CEI = new CEI();
        ...
        private void GetData(string Id)
        {
            try
            {
                if (Convert.ToString(Session["AdminId"]) == hdnStaffId.Value && txtInspectionID.Text != null && txtInspectionID.Text != string.Empty)
                {
                    ...
                    DataTable dt = CEI.GetInspectionAdminOwnerData_Cinema(Id);
        ...
        private void GridToViewTRinMultipleCaseNew(string ID)
        {
            try
            {
                ...
                DataSet dsVC = CEI.GetDetailsToViewCinemaTestReportOAdmin(ID);
                        ...
                        if (RadioButtonList2.SelectedValue != "" && RadioButtonList2.SelectedValue != null)
                        {
                            ...
                            try
                            {
                                ...
                                if (RadioButtonList2.SelectedValue == "2")
                                {
                                    ...
                                    CEI.UpdateInspectionRejection_Cinema_Admin(ID, StaffId, ddlRejectionReasonType.SelectedItem.ToString(), Reason);
                                ...
                                else
                                {
                                    if (InstallType == "New")
                                    {
                                        if (RadioButtonList2.SelectedValue == "0")
                                        {
                                            ...
                                            CEI.InspectionAccepted_Cinema_Admin(ID, StaffId);
        ...
        protected void GridBindDocument(string ID)
        {
            try
            {
                ...
                ds = CEI.ViewDocuments_Cinema(ID);
