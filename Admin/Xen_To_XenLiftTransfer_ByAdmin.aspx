<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Xen_To_XenLiftTransfer_ByAdmin.aspx.cs" Inherits="CEIHaryana.Admin.Xen_To_XenLiftTransfer_ByAdmin" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        <div class="card-body" id="CardId" runat="server" style="background:white;box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
            ...
            <div class="row" id="TransferButton" runat="server" visible="true" style="margin-top: -50px;">
                ...
                <div class="col-md-4" id="DivToAssign" runat="server" visible="false" >
                    <br />
                    <br />
                    <label>
                        Select Staff
                ...
                <div class="col-md-4" id="Div2" runat="server" visible="true" style="margin-top: 79px;">
                ...
                <div class="col-md-12">
                    ...
                    <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" class="table-responsive table table-hover table-striped" runat="server" Width="100%" AutoGenerateColumns="false" BorderWidth="1px" BorderColor="#dbddff">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Currently Assigned To"  ItemStyle-Width="30%">
                                <ItemTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="ddlNewAssigneediv" runat="server" visible="true" style="margin-top: -33px;">
                            <br />
                            <br />
                            <label>
                                TransferTo
    ...
    <script type="text/javascript">
        ...
        function alertWithRedirectUpdation() {
            ...
            window.location.href = "/Admin/Xen_To_XenLiftTransfer_ByAdmin.aspx";
