    ...
    public partial class SldApprovalRequest : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            try
            {
                ...
                ds = CEI.ViewSldDocumentsFoApproval(LoginId);
        ...
        {
            {
                ...
                try
                {
                    ...
                    Industry_Api_Post_DataformatModel ApiPostformatresult = CEI.GetIndustry_OutgoingRequestFormat_Sld(Convert.ToInt32(SLDID), actiontype);
