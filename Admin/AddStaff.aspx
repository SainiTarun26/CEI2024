<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="AddStaff.aspx.cs" Inherits="CEIHaryana.Admin.AddStaff" %>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12" style="text-align: center;">
                        <h7 class="card-title fw-semibold mb-4" id="maincard">Add Staff</h7>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div>
                        <div class="row" style="margin-bottom: 8px;">
                            <div class="col-12">
                                <h7 class="card-title fw-semibold mb-4" style="margin-top: 5%; font-size: 18px !important;">Officers Add Staff</h7>
                            </div>
                        </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="Name">
                                               Staff Name<samp style="color: red"> * </samp>
                                            </label>
                                            <asp:TextBox class="form-control" ID="staffName" runat="server" autocomplete="off" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                                MaxLength="200" Style="margin-left: 18px;">
                                            </asp:TextBox>

                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="staffName" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Please Enter Staff Name</asp:RequiredFieldValidator>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:TextBox class="form-control" ID="staffEmail" onkeydown="return preventEnterSubmit(event)" runat="server" autocomplete="off" Style="margin-left: 18px" TabIndex="6" onkeyup="return ValidateEmail();"></asp:TextBox>

                                            <span id="lblError" style="color: red"></span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="staffEmail" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Required</asp:RequiredFieldValidator>
                        ...
                        <div class="row" style="margin-top: 25px; margin-bottom: -15px;">
                            ...
                            <div class="col-4" style="margin-top: auto; text-align: center;">
                                ...
                                <br />
                                <text id="Resendotp" runat="server" visible="false">
                                    (An OTP has been sent to the email. If you have not received yet, please
                                    <asp:LinkButton ID="LinkButton4" runat="server" AutoPostBack="true" OnClick="LinkButton4_Click">click here to resend</asp:LinkButton>
                                    .)</text>
