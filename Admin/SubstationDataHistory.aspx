<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="SubstationDataHistory.aspx.cs" Inherits="CEIHaryana.Admin.SubstationDataHistory" %>
              ...
              <div class="row ">
                  <div class="col-sm-4 col-md-4">
                      <h6 class="card-title fw-semibold mb-4">
                             <asp:Label ID="lblData" runat="server"></asp:Label>TEST REPORT (SUBSTATION)</h6>
                  </div>
                       ...
                       <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        ...
                        PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging" BorderWidth="1px" BorderColor="#dbddff">
                         ...
                         <%--       <asp:TemplateField HeaderText="Id" Visible="False">
                                ...
                                <asp:TemplateField>
                                    <HeaderStyle Width="41%" CssClass="headercolor"/>
                                    <ItemStyle Width="41%" />
                                    <HeaderTemplate>
