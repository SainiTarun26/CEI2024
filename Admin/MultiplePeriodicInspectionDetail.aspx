<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="MultiplePeriodicInspectionDetail.aspx.cs" Inherits="CEIHaryana.Admin.MultiplePeriodicInspectionDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        ...
        <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
            ...
            <div class="card" style="margin: -11px; padding: 11px; margin-bottom: 20px;">
                <div class="row">
                    <div class="col-md-4">
                        <label>
                            Inspection Application No</label>
                    ...
                    <%--<div class="col-md-4">
                        ...
                        <asp:TextBox class="form-control" ID="txtInspectionType" ReadOnly="true" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    </div>--%>
                    <div class="col-md-4">
                        <label>
                            Type of Applicant
        ...
        <div class="row" style="margin-bottom: 25px;" id="TestReport" runat="server">
            <div class="col-md-4">
                <asp:TextBox ID="txtTestReportId" class="form-control" Visible="false" ReadOnly="true" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
            </div>
        </div>
