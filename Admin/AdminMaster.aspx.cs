...
namespace CEIHaryana.Admin
{
    public partial class AdminMaster : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = cei.AllInspectionHistory();

            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                DataTable dt = ds.Tables[0];

                // Assuming dt has "RecordCount" and "Initiated" columns
                ...
                var valuesInitiated = dt.AsEnumerable().Select(row => row.Field<int>("Initiated")).ToArray();
