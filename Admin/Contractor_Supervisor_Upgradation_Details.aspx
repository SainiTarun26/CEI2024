<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Contractor_Supervisor_Upgradation_Details.aspx.cs" Inherits="CEIHaryana.Admin.Contractor_Supervisor_Upgradation_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label>
                                        Select User Type<samp style="color: red">* </samp>
                                    </label>
                                    <asp:DropDownList class="select-form select2" Style="border: 1px solid #ced4da; border-radius: 5px;"
                                        ID="ddlUserType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlUserType_SelectedIndexChanged">
    ...
    <script>
        function openPartnerModal() {
            var myModal = new bootstrap.Modal(document.getElementById('partnerModal'));
            myModal.show();
        }
    </script>
</asp:Content>
