<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="ZoneMaster.aspx.cs" Inherits="CEIHaryana.Admin.ZoneMaster" %>
            ...
            <div class="card-body">
                <div class="row" style="margin-bottom: 0px;">
                    <div class="col-12" style="text-align: center;">
                        <h7 class="card-title fw-semibold mb-4" id="maincard">ZONE MASTER</h7>
                    </div>
                </div>
                <div class="row">
...
<samp style="color: red">* </samp>
             ...
             <samp style="color: red">* </samp>
                            ...
                            <asp:TextBox class="form-control" ID="txtZoneName" onkeydown="return preventEnterSubmit(event)" onKeyPress="return alphabetKey(event);" TabIndex="8" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
