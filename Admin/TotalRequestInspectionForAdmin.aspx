                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Owner Name">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton runat="server" ID="LnkResetButton" Text='<%# Eval("OwnerName") %>' CssClass="break-text"
                                        CommandName="ShowDetails" CommandArgument='<%# Eval("CreatedBy") %>' />
                                    <%-- OnClientClick="return false;"--%>


                                    <%--<asp:LinkButton runat="server" ID="LnkResetButton" Text='<%# Eval("OwnerName") %>' CssClass="break-text"
                                        CommandName="ShowDetails" CommandArgument='<%# Eval("CreatedBy") %>' OnClientClick="$('#ownerModal').modal('show'); return true;" />--%>
                                </ItemTemplate>
                            </asp:TemplateField>
