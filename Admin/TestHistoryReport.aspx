<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TestHistoryReport.aspx.cs" Inherits="CEIHaryana.Admin.TestHistoryReport" %>
            ...
            <div class="card-body">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px;">
                    ...
                    <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        AutoGenerateColumns="false" onpageindexchanging="GridView1_PageIndexChanging" AllowPaging="true" PageSize="20"
