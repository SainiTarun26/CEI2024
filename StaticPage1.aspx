...
<body style="zoom: 90% !important;">
    <form id="form1" runat="server">
        ...
        <main id="main">
            ...
            <div class="card" style="margin: 20px; padding: 30px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: -10px; height: 500px !important;">
                ...
                <div id="showhide" class="card-body" style="border-radius: 8px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; margin-top: 20px;">
                    <div class="col-md-12">
                            ...
                            <table class="styled-table" style="text-align: center;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="#">View Procedure PDF</a></td>
