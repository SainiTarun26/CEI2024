...
namespace CEIHaryana.Officers
{
    ...
    public partial class Inspection_Cinema_Talkies : System.Web.UI.Page
    {
        CEI CEI = new CEI();
        ...
        private void GetData(string Id)
        {
            try
            {
                if (Convert.ToString(Session["StaffID"]) == hdnStaffId.Value && txtInspectionID.Text != null && txtInspectionID.Text != string.Empty)
                {
                    ...
                    DataTable dt = CEI.GetInspectionOfficerOwnerData_Cinema(Id);
        ...
        private void GridToViewTRinMultipleCaseNew(string ID)
        {
            try
            {
                ...
                DataSet dsVC = CEI.GetDetailsToViewCinemaTestReportOfficer(ID);
