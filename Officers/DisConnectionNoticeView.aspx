<%@ Page Title="" Language="C#" MasterPageFile="~/Officers/Officers.Master" AutoEventWireup="true" CodeBehind="DisConnectionNoticeView.aspx.cs" Inherits="CEIHaryana.Officers.DisConnectionNoticeView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
       ...
       <Columns>
           <asp:TemplateField HeaderText="SNo">
               <HeaderStyle Width="5%" CssClass="headercolor thwidth" />
               <ItemStyle Width="5%" />
               <ItemTemplate>
           ...
           <asp:TemplateField HeaderText="Uploaded Documents" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4%">
               ...
               <HeaderStyle HorizontalAlign="Left" CssClass="headercolor textalign" />
           </asp:TemplateField>
       </Columns>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius: 5px !important">
                    ...
                    <div class="row" id="OwnerAttactment" runat="server" visible="false">
                        <div class="col-md-6" style="margin-top: auto;">
                            <label>Upload Temporary Disconnection Order(TDCO):</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="col-md-6" id="Document" runat="server" visible="false" style="margin-top: auto;">
                            ...
                            <asp:LinkButton ID="lnkODocument" runat="server" OnClick="lnkODocument_Click" Text="Open Document" />
                        </div>
                    </div>
    ...
    <div class="col-md-12"  id="CeiRemarks" runat="server" visible="false">
        ...
        <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Rows="2" ReadOnly="true" CssClass="form-control" autocomplete="off" TabIndex="1" MaxLength="200" Style="margin-left: 18px;"></asp:TextBox>
                        ...
                        <div class="col-md-12" id="OwnerRemarks" runat="server" visible="false">
                            <label>
                              Any Remarks
                           <samp style="color: red">* </samp>
                            </label>
                            <asp:TextBox ID="txtOwnerRemarks" runat="server" TextMode="MultiLine" Rows="2" ReadOnly="true" CssClass="form-control" autocomplete="off" TabIndex="1" MaxLength="200" Style="margin-left: 18px;"></asp:TextBox>
                ...
                <%--</ContentTemplate></asp:UpdatePanel>--%>
                  <asp:HiddenField ID="hnOtherfile" runat="server" />
