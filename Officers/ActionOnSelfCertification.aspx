<%@ Page Title="" Language="C#" MasterPageFile="~/Officers/Officers.Master" AutoEventWireup="true" CodeBehind="ActionOnSelfCertification.aspx.cs" Inherits="CEIHaryana.Officers.ActionOnSelfCertification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
                            ...
                            <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                                ...
                                <div class="row" style="margin-top: 15px;">
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtAddress" TabIndex="8" ReadOnly="true" onkeydown="return preventEnterSubmit(event)" MaxLength="10" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtEmail" TabIndex="8" ReadOnly="true" onkeydown="return preventEnterSubmit(event)" MaxLength="10" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtContact" TabIndex="8" ReadOnly="true" onkeydown="return preventEnterSubmit(event)" MaxLength="10" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                    </div>
            ...
            <div id="Document_List" runat="server" style="padding: 25px !important; padding-top: 0px !important; margin-right: 15px; margin-left: 15px; padding-bottom: 0px !important; margin-top: -20px;">
                ...
                <asp:GridView ID="grd_Documemnts" CssClass="table table-bordered table-striped table-responsive" runat="server" OnRowDataBound="grd_Documemnts_RowDataBound" OnRowCommand="grd_Documemnts_RowCommand" AutoGenerateColumns="false">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="LblPrevious" runat="server" Text='<%#Eval("PreviousDocumentPath") %>'></asp:Label>
                                <asp:Label ID="LblCurrent" runat="server" Text='<%#Eval("CurrentDocumentPath") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Previous Documents" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkPreviousDoc" runat="server"  CommandArgument='<%# Bind("PreviousDocumentPath") %>' CommandName="Select"></asp:LinkButton>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Current Documents" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDocumemtPath" runat="server"  CommandArgument='<%# Bind("CurrentDocumentPath") %>' CommandName="Print"></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="2%"></ItemStyle>
                            <HeaderStyle HorizontalAlign="Left" CssClass="headercolor" />
                        </asp:TemplateField>
                    ...
                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast" />
                      ...
                      <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px !important;margin-left: 40px;
    margin-right: 40px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
    ...
    <asp:RadioButtonList ID="RadioButtonList1" AutoPostBack="true" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" RepeatDirection="Horizontal" TabIndex="25"> 
