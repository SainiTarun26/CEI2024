<%@ Page Title="" Language="C#" MasterPageFile="~/Officers/Officers.Master" AutoEventWireup="true" CodeBehind="SldApproval_Officer.aspx.cs" Inherits="CEIHaryana.Officers.SldApproval_Officer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="https://kit.fontawesome.com/57676f1d80.js" crossorigin="anonymous"></script>
         <link rel="shortcut icon" type="image/png" href="/css2/style.min.css" />
 <link rel="stylesheet" href="/css2/style.css" />
<!-- Favicon (fix: was incorrectly linked to CSS before) -->
...
<!-- Custom / Theme CSS -->
<link rel="stylesheet" href="/css2/style.css">
<link href="/Dashboard_Css/css/font-face.css" rel="stylesheet">
<link href="/Dashboard_Css/css/theme.css" rel="stylesheet">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <h7 class="card-title fw-semibold mb-4" id="maincard">Sld Request Received</h7>
                    </div>
                </div>
                <div class="row">
        ...
        <samp style="color: red">* </samp>
            ...
            <div class="row">
                <div class="col-md-4"></div>
                <div class="col-md-4" style="text-align: center;">
                    <asp:Button type="submit" ID="btnSubmit" TabIndex="22" ValidationGroup="Submit" Text="Submit" OnClientClick="return validateFileUpload();" runat="server" OnClick="btnSubmit_Click" class="btn btn-primary mr-2" Visible="False" />
    ...
    <script type="text/javascript">
        function alertWithRedirectdata() {
            ...
            window.location.href = "/Officers/SldApprovalRequest_AtOfficer.aspx";
        }
