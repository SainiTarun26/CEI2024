...
namespace CEIHaryana.Officers
{
    public partial class DisconnectionRequest : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    if (Convert.ToString(Session["StaffID"]) != null && Convert.ToString(Session["StaffID"]) != string.Empty)
                    {
                        ...
                        hnOwnerId.Value = Session["StaffID"].ToString();
        ...
        public void GridBind(string StaffId)
        {
            try
            {
                DataTable dt = CEI.GetDisconnectionRequestOfficer(StaffId);
        ...
        {
            if (Convert.ToString(hnOwnerId.Value) == Convert.ToString(Session["StaffID"]))
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    Response.Redirect("/Officers/DisConnectionNoticeView.aspx", false);
