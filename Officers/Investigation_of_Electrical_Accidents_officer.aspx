<%@ Page Title="" Language="C#" MasterPageFile="~/Officers/Officers.Master" AutoEventWireup="true" CodeBehind="Investigation_of_Electrical_Accidents_officer.aspx.cs" Inherits="CEIHaryana.Officers.Investigation_of_Electrical_Accidents_officer" %>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px !important; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-4" id="Div1" runat="server" visible="false">
                            ...
                            <asp:TextBox class="form-control" ID="txtSerialNo" ReadOnly="true" Visible="false" autocomplete="off" MaxLength="20" runat="server" Style="margin-left: 18px"></asp:TextBox>
