<%@ Page Title="" Language="C#" MasterPageFile="~/Officers/Officers.Master" AutoEventWireup="true" CodeBehind="DisconnectionRequest.aspx.cs" Inherits="CEIHaryana.Officers.DisconnectionRequest" %>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    ...
                    <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ApprovedDate" HeaderText="Approved/Rejected Date">
                                <HeaderStyle HorizontalAlign="center" Width="15%" CssClass="headercolor" />
