<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OTP.aspx.cs" Inherits="CEIHaryana.OfficerVerification.OTP" %>
...
<path d="M6.5 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1zM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                                                    <path d="M4.5 0A2.5 2.5 0 0 0 2 2.5V14a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2.5A2.5 2.5 0 0 0 11.5 0zM3 2.5A1.5 1.5 0 0 1 4.5 1h7A1.5 1.5 0 0 1 13 2.5v10.795a4.2 4.2 0 0 0-.776-.492C11.392 12.387
                                        ...
                                        <a href="#">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
                                                    ...
                                                    <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12" style="text-align: center; font-size: 22px; font-weight: 800;">
                                                        <asp:Label ID="Label1" runat="server" Text="OTP VERIFICATION"></asp:Label>
                                                    </div>
                                                </div>
                                                <hr />
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtUserId" autocomplete="off" runat="server" MaxLength="50" TabIndex="17" Style="width: 100%;"> </asp:TextBox>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:TextBox ReadOnly="true" class="form-control" ID="txtEmail" autocomplete="off" runat="server" MaxLength="50" TabIndex="17" Style="width: 100%;"> </asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="row" style="margin-top: 25px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="TextBox3">Enter OTP</label>
                                                        <div style="display: flex; gap: 10px; justify-content: center; align-items: center;">
                                                            <asp:TextBox class="form-control" ID="txtOTP" autocomplete="off"
                                                                runat="server" MaxLength="50"
                                                                TabIndex="17" Style="width: 70%;" />

                                                            <asp:Button type="button" ValidationGroup="Submit" AutoPostback="true" ID="btnverifyOTP"
                                                                Text="Verify" runat="server" class="btn btn-primary"
                                                                Style="padding: 10px 20px; border-radius: 5px;" OnClick="btnverifyOTP_Click" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" style="margin-top: 20px;">
                                                    <div class="col-md-12" style="text-align: center;">
                                                        <text>(An OTP has been sent to the email address mentioned above. If you have not received yet, please <asp:LinkButton ID="LinkButton4" runat="server" AutoPostBack="true" OnClick="LinkButton4_Click">click here to resend</asp:LinkButton> .)</text>
                                                    </div>
                                                </div>
