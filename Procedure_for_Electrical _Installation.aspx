<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Procedure_for_Electrical _Installation.aspx.cs" Inherits="CEIHaryana.Procedure_for_Electrical__Installation" %>
 ...
 <br />
  ...
  Page before filling the form)                           
    ...
    margin-right: 0px; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <div class="col-md-12">
                            <h7 class="card-title fw-semibold mb-4" style="font-size: 18px !important;">Procedure for Electrical Installation</h7>
                    ...
                    <div class="row" style="margin-left: 10px;">
                        <img src="UserManual/Flow-Chart-for-LiftSolar-Panel-DG-Set-Renewable-Sources.jpg" />
