<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Functions.aspx.cs" Inherits="CEIHaryana.Functions" %>
 ...
 <br />
  ...
  Page before filling the form)                           
    ...
    margin-right: 0px; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <div class="col-md-12">
                            <h7 class="card-title fw-semibold mb-4" style="font-size: 18px !important;">FUNCTIONS OF ELECTRICAL INSPECTORATE</h7>
                    ...
                    <div class="row" style="margin-left: 10px;">
                        <ul>
                            ...
                            <li>Administration and implementation of provisions of the Electricity Act, 2003.</li>
                            <li>Administration and implementation of Provisions of Indian Electricity Rules,1956 now Central Electricity Authority (Measures relating to Safety and Electric Supply ) Regulations, 2010 for ensuring safety in the electrical installations and maintenance thereof.</li>
                            <li>Inspection of electrical installations (new and periodical) of Licensees/consumers under the above Act, Rules & Regulations and issuance of approval for energisation.</li>
                            <li>Investigation of electrical accidents and recommendation of safety measures against such accidents.</li>
                            <li>Inspection under the Punjab Cinemas (Regulations) Act, 1952 as applicable in the State of Haryana.</li>
                            <li>Matters connected with Central Electricity Authority and P.T.C.C.</li>
                            <li>To discharge duties as Secretary of the State Licensing Board meant for:-
                                <ul>
                                <li>Grant and issue of new Licences to the Wiring Contractors/ up- gradation of such licenses for higher voltages and renewal thereof.</li>
                                <li>Grant and issue of Competency Certificate to Electrical Supervisors /Wireman Permits/Cinema Operator Permits.</li>
                                <li>Electricity Duty accounts/exemption from Electricity Duty.</li>
                                    </ul>
                            </li>
                            <li>Launching of prosecution in respect of offences under the Electricity Act/Regulations.</li>
                            <li>To discharge other duties and responsibilities as may be assigned under the relevant Act/Rules & Regulations by the State Govt.</li>
                            <li>Administration and implementation of provisions of Lifts & Escalators Act, 2008 & Rules</li>
                        </ul>
