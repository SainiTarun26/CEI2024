        ...
        <div>
            <div class="container">
                ...
                <div id="VerifyOPTdiv" class="otp" runat="server">
                    ...
                    <div class="wrapper">
                        <asp:TextBox class="field 1" ID="txtNewPassword" runat="server" TextMode="Password" MaxLength="14" onkeypress="return validateAlphanumeric(event)" onkeyup="movetoNext(this,'TextBox2')"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNewPassword" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Please enter New Password</asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="wrapper">
                        <asp:TextBox class="field 1" ID="txtVerifyPassword" runat="server" TextMode="Password" MaxLength="14"  onkeyup="movetoNext(this,'TextBox2')"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align: center; margin-top: 10px; margin-bottom: -20px;">
                            <asp:Button class="button-79" ID="BtnSave" runat="server" Text="Save" ValidationGroup="Submit" OnClick="BtnSave_Click" OnClientClick="return validateForm()" />
                        </div>
                    </div>
                </div>
            </div>
