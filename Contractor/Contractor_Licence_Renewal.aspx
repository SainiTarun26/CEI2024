<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor/Contractor.Master" AutoEventWireup="true" CodeBehind="Contractor_Licence_Renewal.aspx.cs" Inherits="CEIHaryana.Contractor.Contractor_Licence_Renewal" %>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox class="form-control" ID="txtLicenceOld" runat="server" autocomplete="off" ReadOnly="false" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                MaxLength="200" Style="margin-left: 18px;">
                            </asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            ...
                            <asp:TextBox class="form-control" ID="txtLicenceNew" runat="server" autocomplete="off" ReadOnly="false" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                MaxLength="200" Style="margin-left: 18px;">
                            </asp:TextBox>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4" id="NewDistrict" runat="server" visible="false">
                            ...
                            <%--<asp:DropDownList ID="ddlDistrict1" runat="server" TabIndex="1" class="select-form select2">
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox class="form-control" ID="txtgrnno" runat="server" autocomplete="off" ReadOnly="false" onKeyPress="return alphabetKey(event);" TabIndex="1"
                                MaxLength="200" Style="margin-left: 18px;">
                            </asp:TextBox>
                        </div>
                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-xs-12">
                                                    ...
                                                    <span class="input-group-append">
                                                        ...
                                                        <input type="file" id="Licence" name="Licence" accept=".pdf" style="display: none;" runat="server" onchange="LicenceDialogName()" />
                                                    </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-xs-12">
                                                    ...
                                                    <span class="input-group-append">
                                                        ...
                                                        <input type="file" id="Certificate" name="Undertaking" accept=".pdf" style="display: none;" runat="server" onchange="CertificateDialogName()" />
                                                    </span>
