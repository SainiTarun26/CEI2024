<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor/Contractor.Master" AutoEventWireup="true" CodeBehind="LiftWork_Intimation.aspx.cs" Inherits="CEIHaryana.Contractor.LiftWork_Intimation" %>
                                ...
                                <div class="card" style="padding: 15px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <asp:TextBox class="form-control" ID="txtVoltage" TabIndex="9" Text="650V" Enabled="false" onkeydown="return preventEnterSubmit(event)" onkeyup="return ValidateEmail();" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                Type of Premises
...
font-size: 12px;">Max no. of Installations is only 25.</p>--%>
                                                        ...
                                                        <div id="installationType3" runat="server" visible="false">
                                                            <tr>
                                                                <td>
                                                                    <div class="col-md-12">
                                                                        <asp:TextBox class="form-control" ID="txtinstallationType3" Text="" ReadOnly="true" onkeydown="return preventEnterSubmit(event)" placeholder="" autocomplete="off" runat="server" Style="margin-left: 18px;"></asp:TextBox>
                                                                    </div>
                                                                </td>
                                                                <td>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-bottom: 0px;">
                            ...
                            <asp:DropDownList class="form-control  select-form select2" ID="ddlAnyWork" OnSelectedIndexChanged="ddlAnyWork_SelectedIndexChanged" TabIndex="18" Style="width: 100% !important;" runat="server" AutoPostBack="true">
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                ...
                <div class="card-body" id="Helpline" runat="server" visible="false" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row" id="Div1" runat="server" visible="false">
                            <h4>HELPLINE:</h4>
                            <span style="margin-right: 12px;"></span>
                            <asp:LinkButton ID="LinkButton2" runat="server" AutoPostBack="false">ceihelpdesk2024@gmail.com</asp:LinkButton>
                            <span style="margin-right: 12px;"></span>
                            <h5>7696438770</h5>
                        </div>
