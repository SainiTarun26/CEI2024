<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor/Contractor.Master" AutoEventWireup="true" CodeBehind="Deattatch_Supervisor.aspx.cs" Inherits="CEIHaryana.Contractor.Deattatch_Supervisor" %>
    ...
    <div class="content-wrapper">
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
            <div class="card-body">
                ...
                <asp:HiddenField ID="hdnSupervisorRequestID" runat="server" />
                <%-- </ContentTemplate>
                </asp:UpdatePanel>--%>
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4" style="text-align: center;">
                        <asp:Button ID="btnToDeattach" Text="Deattach" runat="server" OnClick="btnToDeattach_Click" class="btn btn-primary mr-2" />
                    </div>
                </div>
            </div>
        </div>
