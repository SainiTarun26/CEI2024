<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor/Contractor.Master" AutoEventWireup="true" CodeBehind="ReturnedInspectionForPeriodic.aspx.cs" Inherits="CEIHaryana.Contractor.ReturnedInspectionForPeriodic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    color: white !important;
        ...
        div#ContentPlaceHolder1_DivViewTestReport {
            ...
            <div class="card-body">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div style="margin-top: 3%">
                        <asp:GridView ID="GridView1" class="table-responsive table table-hover table-striped" OnRowDataBound="GridView1_RowDataBound" runat="server" Width="100%" AutoGenerateColumns="false" BorderWidth="1px" BorderColor="#dbddff">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Test Report">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkViewTestReport" runat="server" data-modal="modal1" OnClick="lnkViewTestReport_Click">View</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                       ...
                       <div class="card" style="margin: -11px; padding: 11px; margin-bottom: 20px;" id="DivViewTestReport" runat="server" visible="false">
           ...
           <asp:GridView ID="GridView2" CssClass="table table-bordered table-striped table-responsive"  runat="server" AutoGenerateColumns="false">
              <Columns>
                   ...
                   <asp:TemplateField HeaderText="View Test Report" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4%">
                       <ItemTemplate>
                           <asp:LinkButton ID="lnkViewTR" runat="server" Text="View Test Report" OnClick="lnkViewTR_Click" CommandName="ViewTestReport" CommandArgument='<%# Eval("TestReportId") %>' />
                       </ItemTemplate>
                    ...
                    <div class="row" id="AssignSupervisor" runat="server">
                        ...
                        <div class="col-md-4" style="text-align: center; margin-top: 15px;">
                            <asp:Button ID="BtnSubmit" Text="Submit" runat="server" ValidationGroup="Submit" UseSubmitBehavior="false" class="btn btn-primary mr-2" OnClick="BtnSubmit_Click" />
                        </div>
                    </div>
                    <div id="modal1" class="modal">
                        <div class="modal-content">
                            <span class="close" data-modal="modal1">&times;</span>
                            <div class="card-title">Officer Remarks </div>
                            ...
                            <div class="card-title">SiteOwner Remarks </div>
                            <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 15px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                                <asp:Label ID="lblModalSORemarks" runat="server"></asp:Label>
                            </div>
                            <div class="card-title" id="ContractorRemarks" runat="server">Contractor Remarks </div>
