...
"
                            ...
                            <div class="row" style="margin-bottom: 15PX;">
                                <div class="col-sm-12" style="text-align: center; padding-top: 8px; padding-bottom: 8px; border-radius: 10px;">
                                    ...
                                    <h6 class="card-title fw-semibold mb-4" style="font-weight: 700; margin-bottom: 0px !important; font-size: 18PX; text-align: center;">{See rule 6 (3)}
                                    </h6>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="card-title fw-semibold mb-4" style="font-weight: 700; margin-bottom: 0px !important; font-size: 18PX; text-align: center;">PERFORMA FOR GRANT OF CERTIFICATE OF COMPETENCY</h6>
                                </div>
                            </div>
                            <br />
                            <div class="row">
...
<asp:Label 
    ...
    Style="font-weight: 700; width: 900px; display: inline-block; border-bottom: 1px solid black;height:30px;padding-left: 10px;">
</asp:Label>
        ...
        <asp:Image ID="myImage" runat="server" Width="300" Height="90" Style="bottom: 140px; margin-left: -300px;" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <ol>
    <li>
       This Certificate is to be renewed every five years before its expiry date, failing which it will automatically
stand inoperative.</li>
    <li>
