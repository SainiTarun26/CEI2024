                        ...
                        <div id="printableDiv">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 18PX; font-weight: 600; line-height: 2.7;">
                                        ...
                                        <asp:Label ID="lblPermanant" CssClass="uppercase-label" runat="server" Style="font-weight: 700; width: 100%; display: inline-block; border-bottom: 1px solid black; height: 30px; padding-left: 10px;">
                                        </asp:Label>
                                    </h6>
                                </div>
                                <div class="col-12">
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 18PX; font-weight: 600; line-height: 2.7;">
                                        ...
                                        <asp:Label ID="lblCommunicationAddress" CssClass="uppercase-label" runat="server" Style="font-weight: 700; width: 100%; display: inline-block; border-bottom: 1px solid black; height: 30px; padding-left: 10px;">
                                        </asp:Label>
                                    </h6>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" style="padding-right: 0px !important;">
                                    <h6 class="card-title fw-semibold mb-4" style="margin-bottom: 0px !important; font-size: 18PX; font-weight: 600; line-height: 2.7;">
                                        <text>Name of
                                            <asp:Label ID="lblCompanyName" runat="server"></asp:Label>:</text>
