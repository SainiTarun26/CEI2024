<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintCertificate2.aspx.cs" Inherits="CEIHaryana.Print_Forms.PrintCertificate2" %>
                    ...
                    <div class="card-body">
                        <div id="printableDiv">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <br />
                                    <asp:TextBox ID="multilineTextBox" runat="server" TextMode="MultiLine" Rows="1" Columns="30" Text="The SDO, 'OP',S/Divn. No.1,"></asp:TextBox>
                                    <asp:TextBox ID="multilineTextBox1" runat="server" TextMode="MultiLine" Rows="2" Columns="30" Text="UHBVN, Kurukshetra."></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <p>
                                        The subject cited installation was inspected by this department on
                                        <asp:Label ID="Label3" runat="server" Text="14-03-2024"></asp:Label>
                                        ...
                                        <p>
                                            Consistent compliance of the relevant provisions of CEA (Measures Relating to Safety and Electric Supply)
                                        Regulations, 2023 may be ensured in these installations at your end. Please note thate it shall be responsibility of 
                                        the owner of electrical installations to maintain and operate the installations in he condition free from danger and as
                                        recommended by the manufacturer or by the relevant code of practice of the BUreau of Indian Standards.
                                        </p>
                                    </p>
                                </div>
                            </div>
