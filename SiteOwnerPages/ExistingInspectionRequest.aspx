<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="ExistingInspectionRequest.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.ExistingInspectionRequest" %>
                ...
                <div class="row ">
                    <div class="col-sm-4 col-md-12">
                        <h6 class="card-title fw-semibold mb-12">
                            <asp:Label ID="lblData" runat="server"></asp:Label>LIST OF EXISTING INSTALLATIONS(Recently Tested By Authorised Contractor)</h6>
                    </div>
                </div>
            </div>
        </div>
