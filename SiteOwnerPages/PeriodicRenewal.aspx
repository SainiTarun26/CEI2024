                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-md-4">
                            ...
                            <asp:DropDownList class="form-control  select-form select2" Style="width: 100% !important;" ID="ddlAdress" runat="server">
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-4">
                            <label>
                            ...
                            <asp:DropDownList class="form-control  select-form select2" AutoPostBack="true" Style="width: 100% !important;" ID="ddlInstallationType" runat="server">
                            </asp:DropDownList>
                        </div>
                        <div class="col-1" style="margin-top: auto; padding-left: 0px;">
                            <asp:Button type="submit" ID="btnSearch" Text="Search" runat="server" class="btn btn-primary mr-2" OnClick="btnSearch_Click" Style="padding-left: 18px; padding-right: 18px; height: 34px; padding-top: 2px;" />
                        </div>
                    </div>
                    <div>
                        <div class="card" style="padding: 15px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; padding-bottom: 30px;">
                            <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" DataKeyNames="Id" Width="100%" AllowPaging="true" PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging"
                        ...
                        <div class="row" style="margin-top: 25px; margin-bottom: -15px;">
                            <div class="col-4" style="margin-top: auto;">
                                <asp:Button type="submit" ID="BtnProcess" Text="Process" runat="server" OnClick="BtnProcess_Click" class="btn btn-primary mr-2" Style="padding-left: 18px; padding-right: 18px;" />
                            </div>
                        </div>
                    </div>
                </div>
