<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="ViewDisconnectionDetails.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.ViewDisconnectionDetails" %>
...
<asp:LinkButton ID="lnkODocument" runat="server" OnClick="lnkODocument_Click"  Text="Open Document" />
                    ...
                    <div class="row" style="margin-bottom: 0px !important;" id="Suggestion" runat="server" visible="false">
                        <div class="col-md-12">
                            ...
                            <asp:TextBox ID="txtSuggestion" runat="server" TextMode="MultiLine" Rows="2" ReadOnly="true" CssClass="form-control" autocomplete="off" TabIndex="1" MaxLength="200" Style="margin-left: 18px;"></asp:TextBox>
