<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SubstationHistory.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.SubstationHistory" %>
              ...
              <div class="row ">
                  <div class="col-sm-4 col-md-4">
                      <h6 class="card-title fw-semibold mb-4">
                            <asp:Label ID="lblData" runat="server"></asp:Label>TEST REPORT (SUBSTATION TRANSFORMER)</h6>
                  </div>
                      ...
                      <div class="col-4">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9" style="margin-left: -35px;">
                                  <asp:TextBox ID="txtSearch" runat="server" PlaceHolder="Auto Search" class="form-control" onkeydown="return SearchOnEnter(event);" Font-Size="12px" onkeyup="Search_Gridview(this)" style="height:30px;"></asp:TextBox><br />
                              </div>
                          </div>
                      </div>
                  </div>
                       <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        ...
                        PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging" BorderWidth="1px" BorderColor="#dbddff">
                           ...
                           <Columns>
                               ...
                               <%-- <asp:BoundField DataField="TransformerCapacityType" HeaderText="Transformer Capacity">
                                ...
                                <asp:BoundField DataField="PrimaryVoltage" HeaderText="PrimaryVoltage">
                                    <HeaderStyle HorizontalAlign="center" Width="15%" CssClass="headercolor"/>
                                    <ItemStyle HorizontalAlign="center" Width="15%" />
                                </asp:BoundField>
