...
{
    public partial class DisconnectionStatus : System.Web.UI.Page
    {
        ...
        public void GridBind(string OwnerId)
        {
            try
            {
                DataTable dt = CEI.GetDisconnectionStatus_Owner(OwnerId);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (Convert.ToString(hnOwnerId.Value) == Convert.ToString(Session["SiteOwnerId"]))
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    Response.Redirect("/SiteOwnerPages/ViewDisconnectionDetails.aspx", false);
