<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="Investigation_of_Electrical_Accidents_SiteOwner_History.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.Investigation_of_Electrical_Accidents_SiteOwner_History" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="card" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 5px !important">
            ...
            <div id="DocumentInCaseofAmimal" visible="true" runat="server" style="padding: 25px !important; padding-top: 0px !important; margin-right: 15px; margin-left: 15px;">
                ...
                <div class="card-body" id="remarkcard" runat="server" visible="false" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px !important; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" id="Div_Remark" runat="server" visible="false">
                            <label>
                                Remarks
                            </label>
