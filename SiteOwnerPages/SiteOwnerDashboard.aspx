<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="SiteOwnerDashboard.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.SiteOwnerDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        input#ContentPlaceHolder1_txtRejected {
            TEXT-ALIGN: END;
            border: none;
            background: transparent;
            color: white;
        ...
        input#ContentPlaceHolder1_txtApproved {
            TEXT-ALIGN: END;
            border: none;
            background: transparent;
            color: white;
        ...
        input#ContentPlaceHolder1_txtPending {
            TEXT-ALIGN: END;
            border: none;
            background: transparent;
            color: white;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12">
        ...
        <div>
            <div id="printableDiv2">
                <asp:GridView CssClass="table-responsive table table-hover table-striped" ID="GridView3" runat="server" Width="100%" AllowPaging="true" PageSize="20"
                    AutoGenerateColumns="false" BorderWidth="1px" BorderColor="#dbddff">
                    <PagerStyle CssClass="pagination-ys" />
                    <Columns>
                        ...
                        <asp:BoundField DataField="TotalRequest" HeaderText="Total Request">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" CssClass="headercolor" />
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NewApplication" HeaderText="New Application">
                            <HeaderStyle HorizontalAlign="center" Width="13%" CssClass="headercolor" />
                            <ItemStyle HorizontalAlign="center" Width="13%" />
                        </asp:BoundField>
            ...
            <div id="printableDiv">
                <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView4"
                    AllowPaging="true" PageSize="10"
                    AutoPostBack="true" runat="server" Width="100%" AutoGenerateColumns="false" Visible="false"
                    BorderWidth="1px" BorderColor="#dbddff">
                    <PagerStyle CssClass="pagination-ys" />
            ...
            <div class="row" style="text-align: center; margin-top: 10px; margin-bottom: 10px;">
                <div class="col-6" style="text-align: end;" id="Div1" runat="server" visible="false">
                    <a href="/Officers/OfficerDashboard.aspx">
                        <svg xmlns="http://www.w3.org/2000/svg" height="25" width="25" fill="blue" viewBox="0 0 512 512">
                            <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                            <path d="M512 256A256 256 0 1 0 0 256a256 256 0 1 0 512 0zM217.4 376.9L117.5 269.8c-3.5-3.8-5.5-8.7-5.5-13.8s2-10.1 5.5-13.8l99.9-107.1c4.2-4.5 10.1-7.1 16.3-7.1c12.3 0 22.3 10 22.3 22.3l0 57.7 96 0c17.7 0 32 14.3 32 32l0 32c0 17.7-14.3 32-32 32l-96 0 0 57.7c0 12.3-10 22.3-22.3 22.3c-6.2 0-12.1-2.6-16.3-7.1z" />
                ...
                <div class="col-6" id="Div2" runat="server" style="text-align: end; margin-top: auto;">
                    <a href="#" onclick="printDiv2('printableDiv2');"><i class="bi bi-printer-fill"></i></a>
                </div>
                <div class="col-6" id="Div3" runat="server" visible="false" style="text-align: left; margin-top: auto;">
                    <a href="#" onclick="printDiv('printableDiv');"><i class="bi bi-printer-fill"></i></a>
                </div>
            </div>
        </div>
