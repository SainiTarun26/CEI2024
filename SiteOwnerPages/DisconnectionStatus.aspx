<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="DisconnectionStatus.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.DisconnectionStatus" %>
                    ...
                    <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblID" runat="server" Text='<%#Eval("ApplicationNo") %>'></asp:Label>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkId" runat="server" CommandArgument=' <%#Eval("ApplicationNo") %> ' CommandName="Select"><%#Eval("ApplicationNo") %></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>

                           
                            <asp:BoundField DataField="Owner_FirmName" HeaderText="Owner Name">
                            ...
                            <asp:BoundField DataField="ActionDate" HeaderText="Approved/Reject Date">
                                <HeaderStyle HorizontalAlign="center" Width="15%" CssClass="headercolor" />
