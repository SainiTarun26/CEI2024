<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="SelfCertificationStatus.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.SelfCertificationStatus" %>
                    ...
                    <asp:GridView class="table-responsive table table-striped table-hover" ID="GridView1" runat="server" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblSC_ID" runat="server" Text='<%#Eval("SC_ID") %>'></asp:Label>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnCertificationId" runat="server" CommandArgument=' <%#Eval("SC_ID") %> ' CommandName="Select"><%#Eval("SC_ID") %></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="Volatage" HeaderText="Volatage">
                            ...
                            <asp:BoundField DataField="ApprovedDate" HeaderText="Approved/Reject/Return Date">
                                <HeaderStyle HorizontalAlign="center" Width="15%" CssClass="headercolor" />
