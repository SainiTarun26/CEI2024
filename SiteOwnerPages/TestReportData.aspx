<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="TestReportData.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.TestReportData" %>
              ...
              <div class="row ">
                  <div class="col-sm-4 col-md-4">
                     <h6 class="card-title fw-semibold mb-4">
                          <asp:Label ID="lblData" runat="server"></asp:Label>TEST REPORT (LINE)</h6>
                  </div>
                      ...
                      <div class="col-4">
                       ...
                       <asp:GridView class="table-responsive table table-hover table-striped" ID="GridView1" runat="server" Width="100%"
                           ...
                           <Columns>
                                ...
                                <asp:TemplateField HeaderText="Id" Visible="False">
                                    <ItemTemplate>
                                        <asp:Label ID="lblLineLength" runat="server" Text='<%#Eval("LineLength") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
