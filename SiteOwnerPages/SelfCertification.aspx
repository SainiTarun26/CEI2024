                                ...
                                <div class="row" style="margin-top: 15px;">
                                    <div class="col-md-6">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 15px; margin-left: 18px; flex-wrap: wrap;">
                                            ...
                                            <label>
                                                <asp:CheckBox ID="chkLiftOption" runat="server" />
                                                Lift</label>
                                            <br>
                                            <label>
                                                <asp:CheckBox ID="chkEscalatorOption" runat="server" />
                                                Escalator</label>
                                            <label>
                                    ...
                                    <div class="col-md-3" id="OtherInstallation" runat="server" visible="false">
                                        ...
                                        <asp:TextBox class="form-control" ID="txtOtherInstallation" TabIndex="8" onkeydown="return preventEnterSubmit(event)" onKeyPress="return isNumberKey(event);" onkeyup="return isvalidphoneno();" MaxLength="10" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>                                
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <asp:HyperLink ID="lnkForm1" runat="server" NavigateUrl="~/documents/sample.pdf" Text="Document Sample" Target="_blank" />
                                </td>
                                <td>
