<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Cinema_Talkies_Test_Report_Modal_Periodic.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.Print_Cinema_Talkies_Test_Report_Modal_Periodic" %>
                                ...
                                <div id="Div1" runat="server" visible="true">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <asp:TextBox class="form-control" ReadOnly="true" ID="txtLastInspectiondate" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        </div>
                                        <div class="col-4">
                                            <label>
