<%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="Intimation_Cinema_HistoryGridView.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.Intimation_Cinema_HistoryGridView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
         ...
         <asp:BoundField DataField="OwnerName" HeaderText="Site Owner Name">
             <HeaderStyle HorizontalAlign="center" CssClass="GridViewRowHeader headercolor" />
