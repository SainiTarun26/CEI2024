<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cinema_Video_Talkies_TestReport_Modal.aspx.cs" Inherits="CEIHaryana.TestReportModal.Cinema_Video_Talkies_TestReport_Modal" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindow() {
            var newWindow = window.open('../SiteOwnerPages/PRint_Cinema_Talkies_Test_Report_Modal.aspx', '_blank');
            newWindow.focus();
