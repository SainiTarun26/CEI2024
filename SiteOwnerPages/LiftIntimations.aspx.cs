...
{
    public partial class LiftIntimations : System.Web.UI.Page
    {
        CEI cei = new CEI();
        ...
        private void getWorkIntimationData()
        {
            ...
            ds = cei.IntimationDataforSiteOwner(Id);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                //    GetDetails();
                        ...
                        Response.Redirect("/SiteOwnerPages/LiftInstallationDetails.aspx");
