<%@ Page Title="" Language="C#" MasterPageFile="~/Industry/Industry_SiteOwner.Master" AutoEventWireup="true" CodeBehind="GenerateInspection_Industry.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.GenerateInspection_Industry" %>
            ...
            <div class="card-body">
                ...
                <div class="row" id="Test" runat="server" visible="false">
                    ...
                    <div class="col-4">
                        ...
                        <asp:TextBox class="form-control" ID="txtPremises" ReadOnly="true" MaxLength="6"   onKeyPress="return isNumberKey(event);" autocomplete="off" TabIndex="7" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    </div>
                    <div class="col-4">
                        <label>
                            Type of Applicant<samp style="color: red"> * </samp>
                        </label>
                        <asp:TextBox class="form-control" ID="txtApplicantType" ReadOnly="true" MaxLength="6" onKeyPress="return isNumberKey(event);" autocomplete="off" TabIndex="7" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    </div>
                    <div class="col-4">
                        <label>
                            Type of Installation<samp style="color: red"> * </samp>
                        </label>
                        <asp:TextBox class="form-control" ID="txtWorkType" ReadOnly="true" MaxLength="6"  onKeyPress="return isNumberKey(event);" autocomplete="off" TabIndex="7" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    </div>
                    <div class="col-4" runat="server">
                        <label for="Pin">Voltage Level</label>
                        <asp:TextBox class="form-control" ID="txtVoltage" ReadOnly="true" MaxLength="6"  onKeyPress="return isNumberKey(event);" autocomplete="off" TabIndex="7" runat="server" Style="margin-left: 18px"></asp:TextBox>
                    </div>
                    <div class="col-4" runat="server">
                ...
                <div class="card-body" id="SactionVoltage" runat="server" visible="false" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <asp:TextBox class="form-control" ID="txtSaction" MaxLength="6" onKeyPress="return isNumberKey(event);" autocomplete="off" TabIndex="7" runat="server" Style="margin-left: 18px"></asp:TextBox>
...
<%--                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txttransactionId" ErrorMessage="RequiredFieldValidator" ValidationGroup="Submit" ForeColor="Red">Required</asp:RequiredFieldValidator>--%>
    ...
    function alertWithRedirectdata() {
        ...
        window.location.href = "/SiteOwnerPages/InspectionRequestPrint_Industry.aspx";
        //} else {
        //}
    }
    </script>
