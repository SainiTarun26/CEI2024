...
<ContentTemplate>--%>
                    ...
                    <div class="col-md-4" id="Div2" runat="server" visible="true">
                        ...
                        <asp:TextBox class="form-control" ID="txtVoltageLevelAccident" autocomplete="off" MaxLength="20" runat="server" Style="margin-left: 18px"></asp:TextBox>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--  <asp:UpdatePanel ID="updatePandelRadioBtn4" runat="server">
                                      onchange="toggleFileUpload(this, '<%= txtReason4.ClientID %>', '<%= FileUpload4.ClientID %>');">OnClick='<%# "toggleFileUpload(this, \"" + txtReason4.ClientID + "\", \"" + FileUpload4.ClientID + "\")" %>'> 
                                      <%--data-textboxid='<%= txtReason4.ClientID %>' data-fileuploadid='<%= FileUpload4.ClientID %>'--%>
                                        <%--onchange="toggleFileUpload(this, '<%= FileUpload4.ClientID %>', '<%=txtReason4.ClientID%>' ,'<%=lnkBtn_Tick4.ClientID%>')"      onchange="toggleFileUpload(this, \"" + txtReason4.ClientID + "\", \"" + FileUpload4.ClientID + "\");">   --%>
                                        <%--OnChange='<%= "toggleFileUpload(this, \"" + txtReason5.ClientID + "\", \"" + FileUpload5.ClientID + "\")" %>'>--%>
                                        <%--<ContentTemplate>--%>
                                        <%--OnClientClick='<%# "showUpdatePasswordModal(\"" + Eval("UserId") + "\", \"" + Eval("Email") + "\"); return false;" %>' --%>
                                        <div style="margin-top: 0px;">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="rvfRadioButtonList4" ControlToValidate="RadioButtonList4" ForeColor="Red" Display="Dynamic" ValidationGroup="BtnUpload4" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        </div>
                                        <%--  </ContentTemplate>
                                        <Triggers>
                                    ...
                                    <td style="padding-bottom: 0px !important; padding-top: 17px !important; text-align: center;">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="txtReason4" ErrorMessage="RequiredFieldValidator" ValidationGroup="SubmitUpload4" ForeColor="Red">Required</asp:RequiredFieldValidator>
