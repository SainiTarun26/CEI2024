<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Procedure_For_Registration_Lift_Exclator.aspx.cs" Inherits="CEIHaryana.Procedure_For_Registration_Lift_Exclator" %>
 ...
 <br />
  ...
  Page before filling the form)                           
    ...
    margin-right: 0px; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <div class="col-md-12">
                            <h7 class="card-title fw-semibold mb-4" style="font-size: 18px !important;">Checklist for Registration/Inspection of Lifts and Escalators</h7>
                    ...
                    <div class="row" style="margin-left: 10px;">
                        <ol>
                            <li>Copy of Bill/Invoice of Lift or Escalator.
        ...
        <li>Subitem 1.2</li>
                            ...
                            <li>Declaration by Owner (Form A)</li>
                            <li>Declaration by Company (Form B)</li>
                            <li>Declaration by Electrical Contractor. (Form C).</li>
                            <li>Insurance certificate of Lift/Esclator covering insurance for the person using the Lift/Esclator.</li>
                            <li>Anual Maintenance Contract (AMC).</li>
                            <li>Safety Certificate by Installer/Company.</li>
                            <li>Treasury Challan of fees i.e. 3500/- INR (for New).</li>
                        </ol>

                    </div>
                    <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                        <div class="col-md-12">
                            <h7 class="card-title fw-semibold mb-4" style="font-size: 18px !important;">For Renewal of already registered Lift</h7>
                    ...
                    <div class="row" style="margin-left: 10px;">
                        <ol>
                            ...
                            <li>Copy of Lift Registration Certificate.</li>
                            <li>Valid Insurance certificate of Lift/Escalator covering insurance for the person using the Lift/Escalator.</li>
                            <li>Annual Maintenance Contract (AMC).</li>
                            <li>Safety Certificate by Installer/Compant.</li>
                            <li>Treasury Challan of Fees i.e. 1000/- INR (for periodical for 3 years).</li>
                        </ol>
